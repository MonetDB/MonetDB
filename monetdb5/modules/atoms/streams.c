...
mel_func streams_init_funcs[] = {
 ...
 { .command=true, .mod="streams", .fcn="flush", .imp=(fptr)&mnstr_flush_streamwrap, .unsafe=true, .comment="flush the stream", .args={{ .name="s", .type="streams", .isbat=false, .vargs=false }, }, .res={} },
 { .command=true, .mod="streams", .fcn="close", .imp=(fptr)&mnstr_close_streamwrap, .unsafe=true, .comment="close and destroy the stream s", .args={{ .name="s", .type="streams", .isbat=false, .vargs=false }, }, .res={} },
 ...
 { .command=true, .mod="streams", .fcn="destroy", .imp=(fptr)&bstream_destroy_wrapwrap, .unsafe=true, .comment="destroy bstream", .args={{ .name="s", .type="bstream", .isbat=false, .vargs=false }, }, .res={} },
