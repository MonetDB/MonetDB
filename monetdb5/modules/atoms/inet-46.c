...
mel_func inet46_init_funcs[] = {
 ...
 command("inet46", "inet6containsinet6", INETinet6containsinet6, false, "", args(1,5, arg("",bit),arg("ip1",inet6),arg("msk1",bte),arg("ip2",inet6),arg("msk2",bte))),
 command("inet46", "inet6containsinet6", INETinet6containsinet6nomask, false, "", args(1,4, arg("",bit),arg("ip1",inet6),arg("ip2",inet6),arg("msk2",bte))),
 command("inet46", "inet6containsorequalinet6", INETinet6containsorequalinet6, false, "", args(1,5, arg("",bit),arg("ip1",inet6),arg("msk1",bte),arg("ip2",inet6),arg("msk2",bte))),
