...
static mel_func mtime_init_funcs[] = {
 ...
 command("mtime", "month", MTIMEsql_month, false, "", args(1,2, arg("",bte),arg("months",int))),
 pattern("batmtime", "month", MTIMEsql_month_bulk, false, "", args(1,2, batarg("",bte),batarg("months",int))),
 pattern("batmtime", "month", MTIMEsql_month_bulk, false, "", args(1,3, batarg("",bte),batarg("months",int),batarg("s",oid))),
