...
mtime_export str MTIMEoldduration(int *ndays, const char **s);
mtime_export str MTIMEolddate(date *d, const char **buf);
mtime_export str MTIMEtimezone(tzone *z, const char **name);
...
mtime_export str MTIMEmonth_from_str(int *ret, const char **month);
mtime_export str MTIMEmonth_to_str(str *ret, const int *month);
mtime_export str MTIMEday_from_str(int *ret, const char **day);
...
mtime_export str MTIMEdate_fromstr(date *ret, const char **s);
...
mtime_export str MTIMEtimestamp_fromstr(timestamp *ret, const char **d);
...
mtime_export str MTIMEtimestamp_LT(bit *retval, const timestamp *val1, const timestamp *val2);
mtime_export str MTIMEtimestamp_LE(bit *retval, const timestamp *val1, const timestamp *val2);
mtime_export str MTIMEtimestamp_GT(bit *retval, const timestamp *val1, const timestamp *val2);
mtime_export str MTIMEtimestamp_GE(bit *retval, const timestamp *val1, const timestamp *val2);
...
mtime_export str MTIMEtzone_fromstr(tzone *ret, const char **s);
mtime_export str MTIMEdaytime_fromstr(daytime *ret, const char **s);
...
mtime_export str MTIMEruleDef1(rule *ret, const int *m, const char **dnme, const int *w, const int *h, const int *mint);
mtime_export str MTIMEruleDef2(rule *ret, const int *m, const char **dnme, const int *w, const int *mint);
...
mtime_export str MTIMEstrptime(date *d, const char **s, const char **format);
mtime_export str MTIMEstrftime(str *s, const date *d, const char **format);
