...
bat5_export char *BKCsetRole(bat *r, const bat *bid, const char * const *hname, const char * const *tname);
bat5_export char *BKCdestroyImmediate(signed char *r, const bat *bid);
...
bat5_export char *BKCdelete_bat(bat *r, const bat *bid, const bat *bnid);
bat5_export char *BKCdelete_bun(bat *r, const bat *bid, const void *h, const void *t);
bat5_export char *BKCdestroy(signed char *r, bat *bid);
bat5_export char *BKCbat_append_void_bat_wrap(bat *r, const bat *bid, const bat *uid);
bat5_export char * BKCbat_append_val_wrap(bat *r, const bat *bid, const void *u);
...
bat5_export str BKCdelete_bat(bat *r, const bat *bid, const bat *sid);
bat5_export str BKCdestroy_bat(bit *r, const char * const *input);
...
bat5_export str BKCpersists(bat *r, const bat *bid, const bit *flg);
bat5_export str BKCsetPersistent(bat *r, const bat *bid);
bat5_export str BKCisPersistent(bit *res, const bat *bid);
bat5_export str BKCsetTransient(bat *r, const bat *bid);
...
bat5_export str BKCsetColumn(bat *r, const bat *bid, const char * const *tname);
bat5_export str BKCsetColumns(bat *r, const bat *bid, const char * const *hname, const char * const *tname);
bat5_export str BKCsetName(bat *r, const bat *bid, const char * const *s);
...
bat5_export str BKChot(bat *res, const char * const *input);
bat5_export str BKCcold(bat *res, const char * const *input);
bat5_export str BKCcoldBAT(bat *res, const bat *bid);
bat5_export str BKCheat(bat *res, const char * const *input);
bat5_export str BKChotBAT(bat *res, const bat *bid);
bat5_export str BKCsave(bit *res, const char * const *input);
bat5_export str BKCsave2(bat *r, const bat *bid);
...
bat5_export str BKCmadvise(bit *res, const bat *bid, const int *hbns, const int *tbns, const int *hhp, const int *thp);
