...
mel_func algebra_init_funcs[] = {
 ...
 command("algebra", "select", ALGselect2, false, "Select all head values of the first input BAT for which the tail value\nis in range and for which the head value occurs in the tail of the\nsecond input BAT.\nThe first input is a dense-headed BAT, the second input is a\ndense-headed BAT with sorted tail, output is a dense-headed BAT\nwith in the tail the head value of the input BAT for which the\ntail value is between the values low and high (inclusive if li\nrespectively hi is set).  The output BAT is sorted on the tail\nvalue.  If low or high is nil, the boundary is not considered\n(effectively - and + infinity).  If anti is set, the result is the\ncomplement.  Nil values in the tail are never matched, unless\nlow=nil, high=nil, li=1, hi=1, anti=0.  All non-nil values are\nreturned if low=nil, high=nil, and li, hi are not both 1, or anti=1.\nNote that the output is suitable as second input for this\nfunction.", args(1,8, batarg("",cnd),batargany("b",1),batarg("s",cnd),argany("low",1),argany("high",1),arg("li",bit),arg("hi",bit),arg("anti",bit))),
 command("algebra", "select", ALGselect1nil, false, "With unknown set, each nil != nil", args(1,8, batarg("",cnd),batargany("b",1),argany("low",1),argany("high",1),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("unknown",bit))),
 command("algebra", "select", ALGselect2nil, false, "With unknown set, each nil != nil", args(1,9, batarg("",cnd),batargany("b",1),batarg("s",cnd),argany("low",1),argany("high",1),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("unknown",bit))),
 command("algebra", "thetaselect", ALGthetaselect1, false, "Select all head values for which the tail value obeys the relation\nvalue OP VAL.\nInput is a dense-headed BAT, output is a dense-headed BAT with in\nthe tail the head value of the input BAT for which the\nrelationship holds.  The output BAT is sorted on the tail value.", args(1,4, batarg("",cnd),batargany("b",1),argany("val",1),arg("op",str))),
 command("algebra", "thetaselect", ALGthetaselect2, false, "Select all head values of the first input BAT for which the tail value\nobeys the relation value OP VAL and for which the head value occurs in\nthe tail of the second input BAT.\nInput is a dense-headed BAT, output is a dense-headed BAT with in\nthe tail the head value of the input BAT for which the\nrelationship holds.  The output BAT is sorted on the tail value.", args(1,5, batarg("",cnd),batargany("b",1),batarg("s",cnd),argany("val",1),arg("op",str))),
 ...
 command("mask", "select", MSKselect1nil, false, "With unknown set, each nil != nil", args(1,8, batarg("",cnd),batargany("b",1),argany("low",1),argany("high",1),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("unknown",bit))),
 command("mask", "select", MSKselect2nil, false, "With unknown set, each nil != nil", args(1,9, batarg("",cnd),batargany("b",1),batarg("s",cnd),argany("low",1),argany("high",1),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("unknown",bit))),
 ...
 command("algebra", "join", ALGjoin, false, "Join", args(2,8, batarg("",oid),batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "join", ALGjoin, false, "Join", args(2,8, batarg("",oid),batarg("",oid),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "join", ALGjoin, false, "Join", args(2,8, batarg("",oid),batarg("",oid),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "join", ALGjoin1, false, "Join; only produce left output", args(1,7, batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "join", ALGjoin1, false, "Join; only produce left output", args(1,7, batarg("",oid),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "join", ALGjoin1, false, "Join; only produce left output", args(1,7, batarg("",oid),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "leftjoin", ALGleftjoin, false, "Left join with candidate lists", args(2,8, batarg("",oid),batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "leftjoin", ALGleftjoin, false, "Left join with candidate lists", args(2,8, batarg("",oid),batarg("",oid),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "leftjoin", ALGleftjoin, false, "Left join with candidate lists", args(2,8, batarg("",oid),batarg("",oid),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("estimate",lng))),
 ...
 command("algebra", "thetajoin", ALGthetajoin, false, "Theta join with candidate lists", args(2,9, batarg("",oid),batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "thetajoin", ALGthetajoin, false, "Theta join with candidate lists", args(2,9, batarg("",oid),batarg("",oid),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "thetajoin", ALGthetajoin, false, "Theta join with candidate lists", args(2,9, batarg("",oid),batarg("",oid),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "thetajoin", ALGthetajoin1, false, "Theta join with candidate lists; only produce left output", args(1,8, batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "thetajoin", ALGthetajoin1, false, "Theta join with candidate lists; only produce left output", args(1,8, batarg("",oid),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "thetajoin", ALGthetajoin1, false, "Theta join with candidate lists; only produce left output", args(1,8, batarg("",oid),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("op",int),arg("nil_matches",bit),arg("estimate",lng))),
 command("algebra", "bandjoin", ALGbandjoin, false, "Band join: values in l and r match if r - c1 <[=] l <[=] r + c2", args(2,11, batarg("",oid),batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),argany("c1",1),argany("c2",1),arg("li",bit),arg("hi",bit),arg("estimate",lng))),
 command("algebra", "bandjoin", ALGbandjoin1, false, "Band join: values in l and r match if r - c1 <[=] l <[=] r + c2; only produce left output", args(1,10, batarg("",oid),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),argany("c1",1),argany("c2",1),arg("li",bit),arg("hi",bit),arg("estimate",lng))),
 command("algebra", "rangejoin", ALGrangejoin, false, "Range join: values in l and r1/r2 match if r1 <[=] l <[=] r2", args(2,12, batarg("",oid),batarg("",oid),batargany("l",1),batargany("r1",1),batargany("r2",1),batarg("sl",cnd),batarg("sr",cnd),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("symmetric",bit),arg("estimate",lng))),
 command("algebra", "rangejoin", ALGrangejoin1, false, "Range join: values in l and r1/r2 match if r1 <[=] l <[=] r2; only produce left output", args(1,11,batarg("",oid),batargany("l",1),batargany("r1",1),batargany("r2",1),batarg("sl",cnd),batarg("sr",cnd),arg("li",bit),arg("hi",bit),arg("anti",bit),arg("symmetric",bit),arg("estimate",lng))),
 command("algebra", "difference", ALGdifference, false, "Difference of l and r with candidate lists", args(1,8, batarg("",cnd),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("nil_clears",bit),arg("estimate",lng))),
 command("algebra", "difference", ALGdifference, false, "Difference of l and r with candidate lists", args(1,8, batarg("",cnd),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("nil_clears",bit),arg("estimate",lng))),
 command("algebra", "difference", ALGdifference, false, "Difference of l and r with candidate lists", args(1,8, batarg("",cnd),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("nil_clears",bit),arg("estimate",lng))),
 command("algebra", "intersect", ALGintersect, false, "Intersection of l and r with candidate lists (i.e. half of semi-join)", args(1,8, batarg("",cnd),batargany("l",1),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("max_one",bit),arg("estimate",lng))),
 command("algebra", "intersect", ALGintersect, false, "Intersection of l and r with candidate lists (i.e. half of semi-join)", args(1,8, batarg("",cnd),batarg("l",msk),batargany("r",1),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("max_one",bit),arg("estimate",lng))),
 command("algebra", "intersect", ALGintersect, false, "Intersection of l and r with candidate lists (i.e. half of semi-join)", args(1,8, batarg("",cnd),batargany("l",1),batarg("r",msk),batarg("sl",cnd),batarg("sr",cnd),arg("nil_matches",bit),arg("max_one",bit),arg("estimate",lng))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B", args(1,6, batarg("",cnd),batargany("b",0),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B with candidate list S", args(1,7, batarg("",cnd),batargany("b",0),batarg("s",cnd),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B with candidate list S", args(1,8, batarg("",cnd),batargany("b",0),batarg("s",cnd),batarg("g",oid),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B", args(2,7, batarg("",cnd),batarg("",oid),batargany("b",0),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B with candidate list S", args(2,8, batarg("",cnd),batarg("",oid),batargany("b",0),batarg("s",cnd),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 pattern("algebra", "firstn", ALGfirstn, false, "Calculate first N values of B with candidate list S", args(2,9, batarg("",cnd),batarg("",oid),batargany("b",0),batarg("s",cnd),batarg("g",oid),arg("n",lng),arg("asc",bit),arg("nilslast",bit),arg("distinct",bit))),
 ...
 command("aggr", "count", ALGcountCND_bat, false, "Return the current size (in number of elements) in a BAT.", args(1,3, arg("",lng),batargany("b",0),batarg("cnd",cnd))),
 command("aggr", "count", ALGcountCND_nil, false, "Return the number of elements currently in a BAT ignores\nBUNs with nil-tail iff ignore_nils==TRUE.", args(1,4, arg("",lng),batargany("b",0),batarg("cnd",cnd),arg("ignore_nils",bit))),
 command("aggr", "count_no_nil", ALGcountCND_no_nil, false, "Return the number of elements currently\nin a BAT ignoring BUNs with nil-tail", args(1,3, arg("",lng),batargany("b",2),batarg("cnd",cnd))),
