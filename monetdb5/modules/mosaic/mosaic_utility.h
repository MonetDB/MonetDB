...
#define DO_OPERATION_ON_INTEGERS_ONLY_bte(OPERATION, NAME, ...) EXPAND(do_##OPERATION(NAME, bte, __VA_ARGS__))
#define DO_OPERATION_ON_INTEGERS_ONLY_sht(OPERATION, NAME, ...) EXPAND(do_##OPERATION(NAME, sht, __VA_ARGS__))
#define DO_OPERATION_ON_INTEGERS_ONLY_int(OPERATION, NAME, ...) EXPAND(do_##OPERATION(NAME, int, __VA_ARGS__))
#define DO_OPERATION_ON_INTEGERS_ONLY_lng(OPERATION, NAME, ...) EXPAND(do_##OPERATION(NAME, lng, __VA_ARGS__))
...
#ifdef HAVE_HGE
#define DO_OPERATION_ON_INTEGERS_ONLY_hge(OPERATION, NAME, ...) EXPAND(do_##OPERATION(NAME, hge, __VA_ARGS__))
#endif

#define DO_OPERATION_ON_INTEGERS_ONLY(OPERATION, NAME, TPE, ...)    DO_OPERATION_ON_INTEGERS_ONLY_##TPE(OPERATION, NAME, __VA_ARGS__)
#define DO_OPERATION_ON_ALL_TYPES(OPERATION, NAME, TPE, ...)        EXPAND(do_##OPERATION(NAME, TPE, __VA_ARGS__))
