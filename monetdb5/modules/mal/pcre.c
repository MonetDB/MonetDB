...
pcre_export str LIKEsubjoin(bat *r1, bat *r2, const bat *lid, const bat *rid, const bat *slid, const bat *srid, const str *esc);
str
LIKEsubjoin(bat *r1, bat *r2, const bat *lid, const bat *rid, const bat *slid, const bat *srid, const str *esc)
{
	return PCREsubjoin(r1, r2, *lid, *rid, slid ? *slid : 0, srid ? *srid : 0, *esc, 0);
}

pcre_export str ILIKEsubjoin(bat *r1, bat *r2, const bat *lid, const bat *rid, const bat *slid, const bat *srid, const str *esc);
str
ILIKEsubjoin(bat *r1, bat *r2, const bat *lid, const bat *rid, const bat *slid, const bat *srid, const str *esc)
{
	return PCREsubjoin(r1, r2, *lid, *rid, slid ? *slid : 0, srid ? *srid : 0, *esc, 1);
}

str
PCRElike_join_pcre(bat *l, bat *r, const bat *b, const bat *pat, const str *esc)
{
	return PCREsubjoin(l, r, *b, *pat, 0, 0, *esc, 0);
}

str
PCREilike_join_pcre(bat *l, bat *r, const bat *b, const bat *pat, const str *esc)
{
