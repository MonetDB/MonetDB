...
mosaic_export str MOSthetasubselect_delta(Client cntxt,  MOStask task, BUN first, BUN last, void *val, str oper);
mosaic_export str MOSleftfetchjoin_delta(Client cntxt,  MOStask task, BUN first, BUN last);
mosaic_export str MOSjoin_delta(Client cntxt,  MOStask task, BUN first, BUN last);
