...
str runFactory(Client cntxt, MalBlkPtr mb, MalBlkPtr mbcaller, MalStkPtr stk, InstrPtr pci)
	__attribute__((__visibility__("hidden")));
int yieldResult(Client cntxt, MalBlkPtr mb, InstrPtr p, int pc)
	__attribute__((__visibility__("hidden")));
str yieldFactory(Client cntxt, MalBlkPtr mb, InstrPtr p, int pc)
	__attribute__((__visibility__("hidden")));
str callFactory(Client cntxt, MalBlkPtr mb, ValPtr argv[],char flag)
	__attribute__((__visibility__("hidden")));
mal_export void mal_factory_reset(Client c)
	__attribute__((__visibility__("hidden")));
#endif
