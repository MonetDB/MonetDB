...
/* Reset primitives */
__hidden void AUTHreset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_client_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_dataflow_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_factory_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_linker_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_module_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_namespace_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_resource_reset(void)
	__attribute__((__visibility__("hidden")));

__hidden void mal_runtime_reset(void)
	__attribute__((__visibility__("hidden")));
