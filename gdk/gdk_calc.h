...
gdk_export BAT *BATcalcnegate(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcabsolute(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcincr(BAT *b, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalcdecr(BAT *b, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalciszero(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcsign(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcisnil(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcisnotnil(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcnot(BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcmin(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcmin_no_nil(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcmincst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalcmincst_no_nil(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstmin(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalccstmin_no_nil(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcmax(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcmax_no_nil(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcmaxcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalcmaxcst_no_nil(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstmax(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalccstmax_no_nil(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcadd(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcaddcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalccstadd(const ValRecord *v, BAT *b, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcsub(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcsubcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalccstsub(const ValRecord *v, BAT *b, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcmul(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcmulcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalccstmul(const ValRecord *v, BAT *b, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcdiv(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcdivcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalccstdiv(const ValRecord *v, BAT *b, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcmod(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcmodcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalccstmod(const ValRecord *v, BAT *b, BAT *s, BAT *r, int tp, bool abort_on_error);
gdk_export BAT *BATcalcxor(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcxorcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstxor(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcor(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcorcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstor(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcand(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcandcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstand(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalclsh(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalclshcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalccstlsh(const ValRecord *v, BAT *b, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalcrsh(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalcrshcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalccstrsh(const ValRecord *v, BAT *b, BAT *s, BAT *r, bool abort_on_error);
gdk_export BAT *BATcalclt(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcltcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstlt(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcle(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalclecst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstle(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcgt(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcgtcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstgt(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcge(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalcgecst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstge(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalceq(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, bool nil_matches);
gdk_export BAT *BATcalceqcst(BAT *b, const ValRecord *v, BAT *s, BAT *r, bool nil_matches);
gdk_export BAT *BATcalccsteq(const ValRecord *v, BAT *b, BAT *s, BAT *r, bool nil_matches);
gdk_export BAT *BATcalcne(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r, bool nil_matches);
gdk_export BAT *BATcalcnecst(BAT *b, const ValRecord *v, BAT *s, BAT *r, bool nil_matches);
gdk_export BAT *BATcalccstne(const ValRecord *v, BAT *b, BAT *s, BAT *r, bool nil_matches);
gdk_export BAT *BATcalccmp(BAT *b1, BAT *b2, BAT *s1, BAT *s2, BAT *r);
gdk_export BAT *BATcalccmpcst(BAT *b, const ValRecord *v, BAT *s, BAT *r);
gdk_export BAT *BATcalccstcmp(const ValRecord *v, BAT *b, BAT *s, BAT *r);
gdk_export BAT *BATcalcbetween(BAT *b, BAT *lo, BAT *hi, BAT *s, BAT *slo, BAT *shi, BAT *r, bool symmetric, bool linc, bool hinc, bool nils_false, bool anti);
gdk_export BAT *BATcalcbetweencstcst(BAT *b, const ValRecord *lo, const ValRecord *hi, BAT *s, BAT *r, bool symmetric, bool linc, bool hinc, bool nils_false, bool anti);
gdk_export BAT *BATcalcbetweenbatcst(BAT *b, BAT *lo, const ValRecord *hi, BAT *s, BAT *slo, BAT *r, bool symmetric, bool linc, bool hinc, bool nils_false, bool anti);
gdk_export BAT *BATcalcbetweencstbat(BAT *b, const ValRecord *lo, BAT *hi, BAT *s, BAT *shi, BAT *r, bool symmetric, bool linc, bool hinc, bool nils_false, bool anti);
