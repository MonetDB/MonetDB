...
gdk_export BAT *BATcalcmin(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcmin_no_nil(BAT *b1, BAT *b2, BAT *s, int projected);
...
gdk_export BAT *BATcalcmax(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcmax_no_nil(BAT *b1, BAT *b2, BAT *s, int projected);
...
gdk_export BAT *BATcalcadd(BAT *b1, BAT *b2, BAT *s, int tp, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalcsub(BAT *b1, BAT *b2, BAT *s, int tp, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalcmul(BAT *b1, BAT *b2, BAT *s, int tp, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalcdiv(BAT *b1, BAT *b2, BAT *s, int tp, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalcmod(BAT *b1, BAT *b2, BAT *s, int tp, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalcrsh(BAT *b1, BAT *b2, BAT *s, bool abort_on_error, int projected);
...
gdk_export BAT *BATcalclt(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcltcst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstlt(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalcle(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalclecst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstle(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalcgt(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcgtcst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstgt(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalcge(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcgecst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstge(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalceq(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalceqcst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccsteq(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalcne(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcnecst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstne(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalccmp(BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalccmpcst(BAT *b, const ValRecord *v, BAT *s);
gdk_export BAT *BATcalccstcmp(const ValRecord *v, BAT *b, BAT *s);
gdk_export BAT *BATcalcbetween(BAT *b, BAT *lo, BAT *hi, BAT *s, bool symmetric, int projected);
gdk_export BAT *BATcalcbetweencstcst(BAT *b, const ValRecord *lo, const ValRecord *hi, BAT *s, bool symmetric);
gdk_export BAT *BATcalcbetweenbatcst(BAT *b, BAT *lo, const ValRecord *hi, BAT *s, bool symmetric, int projected);
gdk_export BAT *BATcalcbetweencstbat(BAT *b, const ValRecord *lo, BAT *hi, BAT *s, bool symmetric, int projected);
gdk_export gdk_return VARcalcbetween(ValPtr ret, const ValRecord *v, const ValRecord *lo, const ValRecord *hi, bool symmetric);
gdk_export BAT *BATcalcifthenelse(BAT *b, BAT *b1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcifthenelsecst(BAT *b, BAT *b1, const ValRecord *c2, BAT *s, int projected);
gdk_export BAT *BATcalcifthencstelse(BAT *b, const ValRecord *c1, BAT *b2, BAT *s, int projected);
gdk_export BAT *BATcalcifthencstelsecst(BAT *b, const ValRecord *c1, const ValRecord *c2, BAT *s);
