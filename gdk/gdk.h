...
typedef struct BAT {
	...
	bool tnilmask:1;		/* bat has nils separated */
...
#define GDK_ubte_max ((ubte) UINT8_MAX)
#define GDK_ubte_min ((ubte) 0)
#define GDK_sht_max ((sht) INT16_MAX)
#define GDK_sht_min ((sht) INT16_MIN+1)
#define GDK_usht_max ((usht) UINT16_MAX)
#define GDK_usht_min ((usht) 0)
#define GDK_int_max ((int) INT32_MAX)
#define GDK_int_min ((int) INT32_MIN+1)
#define GDK_uint_max ((uint) UINT32_MAX)
#define GDK_uint_min ((uint) 0)
#define GDK_lng_max ((lng) INT64_MAX)
#define GDK_lng_min ((lng) INT64_MIN+1)
#define GDK_ulng_max ((ulng) UINT64_MAX)
#define GDK_ulng_min ((ulng) 0)
#ifdef HAVE_HGE
#define GDK_hge_max ((((hge) 1) << 126) - 1 + (((hge) 1) << 126))
#define GDK_hge_min (-GDK_hge_max)
#define GDK_uhge_max ((((uhge) GDK_ulng_max) << 64) | (uhge) GDK_ulng_max)
#define GDK_uhge_min ((uhge) 0)
#endif
