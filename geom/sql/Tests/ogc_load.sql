...
-- Geometry Columns
INSERT INTO geometry_columns VALUES ('local', 'lakes', 'shore_gid', 'lake_geom',0, 5, 2, 5, 101);
INSERT INTO geometry_columns VALUES ('local', 'road_segments', 'centerline_gid', 'road_segment_geom',0, 3, 2, 3, 101);
INSERT INTO geometry_columns VALUES ('local', 'divided_routes', 'centerlines_gid', 'divided_route_geom',0, 9, 2, 3, 101);
INSERT INTO geometry_columns VALUES ('local', 'forests', 'boundary_gid', 'forest_geom',0, 11, 2, 5, 101);
INSERT INTO geometry_columns VALUES ('local', 'bridges', 'position_gid', 'bridge_geom',0, 1, 2, 1, 101);
INSERT INTO geometry_columns VALUES ('local', 'streams', 'centerline_gid', 'stream_geom',0, 3, 2, 3, 101);
INSERT INTO geometry_columns VALUES ('local', 'buildings', 'position_gid', 'building_pt_geom',0, 1, 2, 1, 101);
INSERT INTO geometry_columns VALUES ('local', 'buildings', 'footprint_gid', 'building_area_geom',0, 5, 2, 5, 101);
INSERT INTO geometry_columns VALUES ('local', 'ponds', 'shores_gid', 'pond_geom',0, 11, 2, 4, 101);
INSERT INTO geometry_columns VALUES ('local', 'named_places', 'boundary_gid', 'named_place_geom',0, 5, 2, 4, 101);
INSERT INTO geometry_columns VALUES ('local', 'map_neatlines', 'neatline_gid', 'map_neatline_geom',0, 5, 2, 5, 101);
