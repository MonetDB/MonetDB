...
--INSERT INTO geometry_columns (f_table_catalog, f_table_schema, f_table_name, f_geometry_column, coord_dimension, srid, type) VALUES ('', 'sys','wmstest','pt',2,4326,'POLYGON');
...
DROP TABLE wmstest;
--DELETE FROM geometry_columns WHERE f_table_name = 'wmstest' AND f_table_schema = 'sys';
SELECT 'Done.';
