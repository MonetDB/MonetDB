...
insert into tbl1 values(1,st_geomfromtext('LINESTRING(1 1, 3 3)'));
insert into tbl2 values(2,st_geomfromtext('LINESTRING(0 0, 4 4)'));
insert into tbl2 values(3,st_geomfromtext('LINESTRING(2 2, 4 4)'));
insert into tbl2 values(4,st_geomfromtext('LINESTRING(1 1, 3 3)'));
