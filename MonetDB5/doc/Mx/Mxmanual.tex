...
The preferred output is Texinfo format, which provides a basis
to generate both printable and web-enabled documentation.
\footnote{Backward compatibility to produce \LaTeX\ 
``troff -ms'' and Netscape-enhanced HTML 
formatting programs is also supported. }
...
The {\tt -i} option produces a file to be processed by
makeinfo. Use the option {\tt -i -B} to produce a body
file to be included in a texinfo file.
