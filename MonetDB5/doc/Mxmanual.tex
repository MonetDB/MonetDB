...
The option {\tt -B} just extracts the HTML body code.
...
The text following a code directive uptil another \Mx directive,
...
file sections, subsections and subsubsections can be defined. 
...
@ifdef PPMX & The body-less macro PPMX can be defined on the copmmand line.\\
@=copy & \\
