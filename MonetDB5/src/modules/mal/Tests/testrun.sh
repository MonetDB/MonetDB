...
mserver5 --set monet_prompt='' <fastcrack_ZeroOrdered_SI.mal |egrep -v '^[# ]|, true\]$|^\[ "" \]$'
...
#mserver5 --set monet_prompt='' <fastcrack_OneOrdered_SI.mal |egrep -v '^[# ]|, true\]$|^\[ "" \]$'
...
#mserver5 --set monet_prompt='' <fastcrack_TwoOrdered_SI.mal |egrep -v '^[# ]|, true\]$|^\[ "" \]$'
