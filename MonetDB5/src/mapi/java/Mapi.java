...
*/
	public static String hostname( String monetport ){
		int pos = monetport.indexOf(':');
		if (pos <= 1)
		   	return "localhost";
		return monetport.substring( 0,pos);
	}

	public static int portnr( String monetport ){
		int pos = monetport.indexOf(':');
		if (pos >= 0 && pos < monetport.length()){
			return Integer.parseInt(monetport.substring( pos+1 ));
		} 
		return 50000;
	}
