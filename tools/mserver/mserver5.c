...
monet_hello(void)
{
	...
	len = snprintf(monetdb_characteristics, sizeof(monetdb_characteristics)-1, "{ \"MonetDBversion\":\"%s\", ", VERSION);
	len += snprintf(monetdb_characteristics + len, sizeof(monetdb_characteristics)-1-len, "\"release\":\"%s\", ", MONETDB_RELEASE);
	len += snprintf(monetdb_characteristics + len, sizeof(monetdb_characteristics)-1-len, "\"host\":\"%s\", ", HOST);
	len += snprintf(monetdb_characteristics + len, sizeof(monetdb_characteristics)-1-len, "\"threads\":\"%d\", ", GDKnr_threads);
	len += snprintf(monetdb_characteristics + len, sizeof(monetdb_characteristics)-1-len, "\"memory\":\"%.3f %cB\", ", sz_mem_h, qc[qi]);
	len += snprintf(monetdb_characteristics + len, sizeof(monetdb_characteristics)-1-len, "\"oid\":\""SZFMT"\", ", sizeof(oid) *8);
