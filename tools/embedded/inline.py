...
os.chdir(wd)
open("monetdb5/mal/mal_init_inline.h", "w").write("char* mal_init_inline = \"" + to_hex(s) + "\";\n")
...
os.chdir(wd)
open("sql/backends/monet5/createdb_inline.h", "w").write("char* createdb_inline = \"" + to_hex(s) + "\";\n")
