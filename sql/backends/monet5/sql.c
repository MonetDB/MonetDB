...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,5, argany("",0),argany("b",0),argany("n",1),arg("s",lng),arg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),argany("n",1),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,5, batargany("",0),argany("b",0),batargany("n",1),arg("s",lng),arg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),batargany("n",1),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "min", SQLmin_global, false, "return the minimum of groups", args(1,3, argany("",1),argany("b",1),arg("t",int))),
 pattern("batsql", "min", SQLmin_global, false, "return the minimum of groups", args(1,3, batargany("",1),batargany("b",1),arg("t",int))),
 pattern("sql", "min", SQLmin_global, false, "return the minimum of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("p",bit))),
 pattern("batsql", "min", SQLmin_global, false, "return the minimum of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("p",bit))),
 pattern("sql", "min", SQLmin_global, false, "return the minimum of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("o",bit))),
 pattern("batsql", "min", SQLmin_global, false, "return the minimum of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit))),
 pattern("sql", "min", SQLmin_global, false, "return the minimum of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "min", SQLmin_global, false, "return the minimum of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "min", SQLmin, false, "return the minimum of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "min", SQLmin, false, "return the minimum of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "min", SQLmin, false, "return the minimum of groups", args(1,6, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "min", SQLmin, false, "return the minimum of groups", args(1,6, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "max", SQLmax_global, false, "return the maximum of groups", args(1,3, argany("",1),argany("b",1),arg("t",int))),
 pattern("batsql", "max", SQLmax_global, false, "return the maximum of groups", args(1,3, batargany("",1),batargany("b",1),arg("t",int))),
 pattern("sql", "max", SQLmax_global, false, "return the maximum of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("p",bit))),
 pattern("batsql", "max", SQLmax_global, false, "return the maximum of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("p",bit))),
 pattern("sql", "max", SQLmax_global, false, "return the maximum of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("o",bit))),
 pattern("batsql", "max", SQLmax_global, false, "return the maximum of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit))),
 pattern("sql", "max", SQLmax_global, false, "return the maximum of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "max", SQLmax_global, false, "return the maximum of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "max", SQLmax, false, "return the maximum of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "max", SQLmax, false, "return the maximum of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "max", SQLmax, false, "return the maximum of groups", args(1,6, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "max", SQLmax, false, "return the maximum of groups", args(1,6, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "count", SQLcount_global, false, "return count of groups", args(1,4, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int))),
 pattern("batsql", "count", SQLcount_global, false, "return count of groups", args(1,4, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int))),
 pattern("sql", "count", SQLcount_global, false, "return count of groups", args(1,5, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int),arg("p",bit))),
 pattern("batsql", "count", SQLcount_global, false, "return count of groups", args(1,5, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int),batarg("p",bit))),
 pattern("sql", "count", SQLcount_global, false, "return count of groups", args(1,5, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int),arg("o",bit))),
 pattern("batsql", "count", SQLcount_global, false, "return count of groups", args(1,5, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int),batarg("o",bit))),
 pattern("sql", "count", SQLcount_global, false, "return count of groups", args(1,6, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "count", SQLcount_global, false, "return count of groups", args(1,6, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "count", SQLcount, false, "return count of groups", args(1,6, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "count", SQLcount, false, "return count of groups", args(1,6, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "count", SQLcount, false, "return count of groups", args(1,7, arg("",lng),argany("b",1),arg("ignils",bit),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "count", SQLcount, false, "return count of groups", args(1,7, batarg("",lng),batargany("b",1),arg("ignils",bit),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",lng),arg("b",bte),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",lng),batarg("b",bte),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",lng),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",lng),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",lng),arg("b",bte),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",lng),batarg("b",bte),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",lng),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",lng),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",lng),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",lng),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",lng),arg("b",sht),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",lng),batarg("b",sht),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",lng),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",lng),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",lng),arg("b",sht),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",lng),batarg("b",sht),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",lng),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",lng),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",lng),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",lng),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",lng),arg("b",int),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",lng),batarg("b",int),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",int),arg("t",int),batarg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",lng),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",lng),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",lng),arg("b",int),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",lng),batarg("b",int),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",lng),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",lng),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",lng),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",lng),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",lng),arg("b",lng),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",lng),batarg("b",lng),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",lng),arg("b",lng),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",lng),batarg("b",lng),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",flt),arg("b",flt),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",flt),batarg("b",flt),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",flt),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",flt),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",flt),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",flt),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",flt),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",flt),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",flt),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",flt),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",flt),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",flt),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",flt),arg("b",flt),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",flt),batarg("b",flt),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",flt),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",flt),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",flt),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",flt),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",flt),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",flt),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",flt),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",flt),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",flt),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",flt),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",bte),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",bte),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",sht),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",sht),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",int),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",int),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",lng),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",lng),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, arg("",bte),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, batarg("",bte),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, arg("",bte),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, batarg("",bte),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, arg("",bte),arg("b",bte),arg("t",int))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, batarg("",bte),batarg("b",bte),arg("t",int))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",bte),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",bte),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",bte),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",bte),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, arg("",bte),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, batarg("",bte),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, arg("",sht),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, batarg("",sht),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, arg("",sht),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, batarg("",sht),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, arg("",sht),arg("b",sht),arg("t",int))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, batarg("",sht),batarg("b",sht),arg("t",int))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",sht),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",sht),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",sht),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",sht),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, arg("",sht),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, batarg("",sht),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, arg("",int),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, batarg("",int),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, arg("",int),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, batarg("",int),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, arg("",int),arg("b",int),arg("t",int))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, batarg("",int),batarg("b",int),arg("t",int))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",int),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",int),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",int),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",int),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, arg("",int),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, batarg("",int),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, arg("",lng),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, batarg("",lng),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, arg("",lng),arg("b",lng),arg("t",int))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, batarg("",lng),batarg("b",lng),arg("t",int))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, arg("",lng),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, batarg("",lng),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",bte),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",bte),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",sht),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",sht),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",int),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",int),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",lng),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",lng),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",bte),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",bte),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",sht),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",sht),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",int),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",int),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",lng),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",lng),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",bte),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",bte),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",sht),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",sht),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",int),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",int),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",lng),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",lng),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",bte),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",bte),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",sht),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",sht),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",int),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",int),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",lng),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",lng),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",flt),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",flt),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",dbl),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",dbl),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",bte),arg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",bte),arg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",bte),batarg("c",bte),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",bte),batarg("c",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",sht),arg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",sht),arg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",sht),batarg("c",sht),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",sht),batarg("c",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",int),arg("c",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",int),arg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",int),batarg("c",int),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",int),batarg("c",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",lng),arg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",lng),arg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",lng),batarg("c",lng),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",lng),batarg("c",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",flt),arg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",flt),arg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",flt),batarg("c",flt),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",flt),batarg("c",flt),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",dbl),arg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),arg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",dbl),batarg("c",dbl),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",dbl),batarg("c",dbl),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,3, arg("",str),arg("b",str),arg("t",int))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,3, batarg("",str),batarg("b",str),arg("t",int))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,4, arg("",str),arg("b",str),arg("sep",str),arg("t",int))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,4, batarg("",str),batarg("b",str),arg("sep",str),arg("t",int))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,4, batarg("",str),arg("b",str),batarg("sep",str),arg("t",int))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,4, batarg("",str),batarg("b",str),batarg("sep",str),arg("t",int))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,4, arg("",str),arg("b",str),arg("t",int),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,4, batarg("",str),batarg("b",str),arg("t",int),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,5, arg("",str),arg("b",str),arg("sep",str),arg("t",int),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,5, batarg("",str),batarg("b",str),arg("sep",str),arg("t",int),batarg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,5, batarg("",str),arg("b",str),batarg("sep",str),arg("t",int),batarg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,5, batarg("",str),batarg("b",str),batarg("sep",str),arg("t",int),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,5, arg("",str),arg("b",str),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups", args(1,5, batarg("",str),batarg("b",str),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,6, arg("",str),arg("b",str),arg("sep",str),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),batarg("b",str),arg("sep",str),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),arg("b",str),batarg("sep",str),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat_global, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),batarg("b",str),batarg("sep",str),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups", args(1,5, arg("",str),arg("b",str),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups", args(1,5, batarg("",str),batarg("b",str),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,6, arg("",str),arg("b",str),arg("sep",str),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),batarg("b",str),arg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),arg("b",str),batarg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,6, batarg("",str),batarg("b",str),batarg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups", args(1,6, arg("",str),arg("b",str),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups", args(1,6, batarg("",str),batarg("b",str),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,7, arg("",str),arg("b",str),arg("sep",str),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,7, batarg("",str),batarg("b",str),arg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng),arg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,7, batarg("",str),arg("b",str),batarg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "str_group_concat", SQLstrgroup_concat, false, "return the string concatenation of groups with a custom separator", args(1,7, batarg("",str),batarg("b",str),batarg("sep",str),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 /* sql_subquery */
 ...
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",hge),arg("b",bte),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",bte),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",hge),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",hge),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",hge),arg("b",bte),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",hge),batarg("b",bte),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",bte),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",bte),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",bte),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",bte),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",hge),arg("b",bte),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",bte),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",hge),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",hge),arg("b",bte),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",hge),batarg("b",bte),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",hge),arg("b",sht),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",sht),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",hge),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",hge),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",hge),arg("b",sht),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",hge),batarg("b",sht),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",sht),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",sht),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",sht),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",sht),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",hge),arg("b",sht),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",sht),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",hge),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",hge),arg("b",sht),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",hge),batarg("b",sht),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",hge),arg("b",int),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",int),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",hge),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",hge),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",hge),arg("b",int),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",hge),batarg("b",int),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",int),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",int),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",int),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",int),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",hge),arg("b",int),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",int),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",hge),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",hge),arg("b",int),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",hge),batarg("b",int),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",hge),arg("b",lng),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",lng),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",hge),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",hge),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",hge),arg("b",lng),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",hge),batarg("b",lng),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",hge),arg("b",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",hge),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",hge),arg("b",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",hge),batarg("b",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, arg("",hge),arg("b",hge),arg("t",int))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",hge),arg("t",int))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "sum", SQLsum, false, "return the sum of groups", args(1,6, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,6, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, arg("",hge),arg("b",hge),arg("t",int))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,3, batarg("",hge),batarg("b",hge),arg("t",int))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "prod", SQLprod_global, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "prod", SQLprod, false, "return the product of groups", args(1,6, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "prod", SQLprod, false, "return the product of groups", args(1,6, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, arg("",dbl),arg("b",hge),arg("t",int))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,3, batarg("",dbl),batarg("b",hge),arg("t",int))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavg_global, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavg, false, "return the average of groups", args(1,6, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavg, false, "return the average of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, arg("",hge),arg("b",hge),arg("t",int))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,3, batarg("",hge),batarg("b",hge),arg("t",int))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,4, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger_global, false, "return the average of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,5, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, arg("",hge),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,6, batarg("",hge),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, arg("",dbl),arg("b",hge),arg("t",int))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,3, batarg("",dbl),batarg("b",hge),arg("t",int))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp_global, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdev", SQLstddev_samp, false, "return the standard deviation sample of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, arg("",dbl),arg("b",hge),arg("t",int))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,3, batarg("",dbl),batarg("b",hge),arg("t",int))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop_global, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "stdevp", SQLstddev_pop, false, "return the standard deviation population of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, arg("",dbl),arg("b",hge),arg("t",int))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,3, batarg("",dbl),batarg("b",hge),arg("t",int))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp_global, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variance", SQLvar_samp, false, "return the variance sample of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, arg("",dbl),arg("b",hge),arg("t",int))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,3, batarg("",dbl),batarg("b",hge),arg("t",int))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit))),
 pattern("sql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop_global, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, arg("",dbl),arg("b",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "variancep", SQLvar_pop, false, "return the variance population of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,4, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp_global, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariance", SQLcovar_samp, false, "return the covariance sample value of groups", args(1,7, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,4, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop_global, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "covariancep", SQLcovar_pop, false, "return the covariance population value of groups", args(1,7, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,4, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,5, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int))),
 pattern("sql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr_global, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("p",bit))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,6, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, arg("",dbl),arg("b",hge),arg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",hge),arg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),arg("b",hge),batarg("c",hge),arg("t",int),arg("s",lng),arg("e",lng),batarg("p",bit))),
 pattern("batsql", "corr", SQLcorr, false, "return the correlation value of groups", args(1,7, batarg("",dbl),batarg("b",hge),batarg("c",hge),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
