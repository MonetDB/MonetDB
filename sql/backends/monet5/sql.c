...
SQLstr_column_stop_vacuum(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci)
{
	...
	if (strNil(sname))
		throw(SQL, "sql.str_column_stop_vacuum", SQLSTATE(42000) "Schema name cannot be NULL");
	if (strNil(tname))
		throw(SQL, "sql.str_column_stop_vacuum", SQLSTATE(42000) "Table name cannot be NULL");
	if (strNil(cname))
		throw(SQL, "sql.str_column_stop_vacuum", SQLSTATE(42000) "Column name cannot be NULL");
	if ((s = mvc_bind_schema(m, sname)) == NULL)
...
static mel_func sql_init_funcs[] = {
 ...
 pattern("batcalc", "identity", BATSQLidentity, false, "Returns the unique row identitfiers with a candidate list input.", args(1,3, batarg("",oid),batargany("b",0), batarg("s",oid))),
 pattern("batcalc", "identity", PBATSQLidentity, false, "Returns the unique row identitfiers with a candidate list input.", args(2,5, batarg("resb",oid),arg("ntseq",oid),batargany("b",0),arg("tseq",oid),batarg("s",oid))),
 ...
 command("calc", "round", bte_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,5, arg("",bte),arg("v",bte),arg("r",bte),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", bte_bat_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",bte),batarg("v",bte),arg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", bte_bat_round_wrap_cst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",bte),arg("v",bte),batarg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", bte_bat_round_wrap_nocst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,7, batarg("",bte),batarg("v",bte),batarg("r",bte),batarg("s1",oid),batarg("s2",oid),arg("digits",int),arg("scale",int))),
 ...
 command("calc", "round", sht_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,5, arg("",sht),arg("v",sht),arg("r",bte),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", sht_bat_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",sht),batarg("v",sht),arg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", sht_bat_round_wrap_cst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",sht),arg("v",sht),batarg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", sht_bat_round_wrap_nocst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,7, batarg("",sht),batarg("v",sht),batarg("r",bte),batarg("s1",oid),batarg("s2",oid),arg("digits",int),arg("scale",int))),
 ...
 command("calc", "round", int_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,5, arg("",int),arg("v",int),arg("r",bte),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", int_bat_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",int),batarg("v",int),arg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", int_bat_round_wrap_cst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",int),arg("v",int),batarg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", int_bat_round_wrap_nocst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,7, batarg("",int),batarg("v",int),batarg("r",bte),batarg("s1",oid),batarg("s2",oid),arg("digits",int),arg("scale",int))),
 ...
 command("calc", "round", lng_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,5, arg("",lng),arg("v",lng),arg("r",bte),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", lng_bat_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",lng),batarg("v",lng),arg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", lng_bat_round_wrap_cst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",lng),arg("v",lng),batarg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", lng_bat_round_wrap_nocst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,7, batarg("",lng),batarg("v",lng),batarg("r",bte),batarg("s1",oid),batarg("s2",oid),arg("digits",int),arg("scale",int))),
 ...
 pattern("calc", "str", SQLstr_cast, false, "cast to string and check for overflow", args(1,7, arg("",str),arg("eclass",int),arg("digits1",int),arg("scale1",int),arg("has_tz",int),argany("v",1),arg("digits",int))),
 pattern("batcalc", "str", SQLbatstr_cast, false, "cast to string and check for overflow", args(1,8, batarg("",str),arg("eclass",int),arg("digits1",int),arg("scale1",int),arg("has_tz",int),batargany("v",1),batarg("s",oid),arg("digits",int))),
 ...
 command("calc", "bte", bte_dec2_bte, false, "cast decimal(bte) to bte and check for overflow", args(1,3, arg("",bte),arg("scale1",int),arg("v",bte))),
 command("calc", "bte", bte_dec2dec_bte, false, "cast decimal(bte) to decimal(bte) and check for overflow", args(1,5, arg("",bte),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "bte", batbte_dec2_bte, false, "cast decimal(bte) to bte and check for overflow", args(1,4, batarg("",bte),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "bte", batbte_dec2dec_bte, false, "cast decimal(bte) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "bte", sht_dec2_bte, false, "cast decimal(sht) to bte and check for overflow", args(1,3, arg("",bte),arg("scale1",int),arg("v",sht))),
 command("calc", "bte", sht_dec2dec_bte, false, "cast decimal(sht) to decimal(bte) and check for overflow", args(1,5, arg("",bte),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "bte", batsht_dec2_bte, false, "cast decimal(sht) to bte and check for overflow", args(1,4, batarg("",bte),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "bte", batsht_dec2dec_bte, false, "cast decimal(sht) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "bte", int_dec2_bte, false, "cast decimal(int) to bte and check for overflow", args(1,3, arg("",bte),arg("scale1",int),arg("v",int))),
 command("calc", "bte", int_dec2dec_bte, false, "cast decimal(int) to decimal(bte) and check for overflow", args(1,5, arg("",bte),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "bte", batint_dec2_bte, false, "cast decimal(int) to bte and check for overflow", args(1,4, batarg("",bte),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "bte", batint_dec2dec_bte, false, "cast decimal(int) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "bte", lng_dec2_bte, false, "cast decimal(lng) to bte and check for overflow", args(1,3, arg("",bte),arg("scale1",int),arg("v",lng))),
 command("calc", "bte", lng_dec2dec_bte, false, "cast decimal(lng) to decimal(bte) and check for overflow", args(1,5, arg("",bte),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "bte", batlng_dec2_bte, false, "cast decimal(lng) to bte and check for overflow", args(1,4, batarg("",bte),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "bte", batlng_dec2dec_bte, false, "cast decimal(lng) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "sht", bte_dec2_sht, false, "cast decimal(bte) to sht and check for overflow", args(1,3, arg("",sht),arg("scale1",int),arg("v",bte))),
 command("calc", "sht", bte_dec2dec_sht, false, "cast decimal(bte) to decimal(sht) and check for overflow", args(1,5, arg("",sht),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "sht", batbte_dec2_sht, false, "cast decimal(bte) to sht and check for overflow", args(1,4, batarg("",sht),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "sht", batbte_dec2dec_sht, false, "cast decimal(bte) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "sht", sht_dec2_sht, false, "cast decimal(sht) to sht and check for overflow", args(1,3, arg("",sht),arg("scale1",int),arg("v",sht))),
 command("calc", "sht", sht_dec2dec_sht, false, "cast decimal(sht) to decimal(sht) and check for overflow", args(1,5, arg("",sht),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "sht", batsht_dec2_sht, false, "cast decimal(sht) to sht and check for overflow", args(1,4, batarg("",sht),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "sht", batsht_dec2dec_sht, false, "cast decimal(sht) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "sht", int_dec2_sht, false, "cast decimal(int) to sht and check for overflow", args(1,3, arg("",sht),arg("scale1",int),arg("v",int))),
 command("calc", "sht", int_dec2dec_sht, false, "cast decimal(int) to decimal(sht) and check for overflow", args(1,5, arg("",sht),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "sht", batint_dec2_sht, false, "cast decimal(int) to sht and check for overflow", args(1,4, batarg("",sht),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "sht", batint_dec2dec_sht, false, "cast decimal(int) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "sht", lng_dec2_sht, false, "cast decimal(lng) to sht and check for overflow", args(1,3, arg("",sht),arg("scale1",int),arg("v",lng))),
 command("calc", "sht", lng_dec2dec_sht, false, "cast decimal(lng) to decimal(sht) and check for overflow", args(1,5, arg("",sht),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "sht", batlng_dec2_sht, false, "cast decimal(lng) to sht and check for overflow", args(1,4, batarg("",sht),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "sht", batlng_dec2dec_sht, false, "cast decimal(lng) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "int", bte_dec2_int, false, "cast decimal(bte) to int and check for overflow", args(1,3, arg("",int),arg("scale1",int),arg("v",bte))),
 command("calc", "int", bte_dec2dec_int, false, "cast decimal(bte) to decimal(int) and check for overflow", args(1,5, arg("",int),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "int", batbte_dec2_int, false, "cast decimal(bte) to int and check for overflow", args(1,4, batarg("",int),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "int", batbte_dec2dec_int, false, "cast decimal(bte) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "int", sht_dec2_int, false, "cast decimal(sht) to int and check for overflow", args(1,3, arg("",int),arg("scale1",int),arg("v",sht))),
 command("calc", "int", sht_dec2dec_int, false, "cast decimal(sht) to decimal(int) and check for overflow", args(1,5, arg("",int),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "int", batsht_dec2_int, false, "cast decimal(sht) to int and check for overflow", args(1,4, batarg("",int),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "int", batsht_dec2dec_int, false, "cast decimal(sht) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "int", int_dec2_int, false, "cast decimal(int) to int and check for overflow", args(1,3, arg("",int),arg("scale1",int),arg("v",int))),
 command("calc", "int", int_dec2dec_int, false, "cast decimal(int) to decimal(int) and check for overflow", args(1,5, arg("",int),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "int", batint_dec2_int, false, "cast decimal(int) to int and check for overflow", args(1,4, batarg("",int),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "int", batint_dec2dec_int, false, "cast decimal(int) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "int", lng_dec2_int, false, "cast decimal(lng) to int and check for overflow", args(1,3, arg("",int),arg("scale1",int),arg("v",lng))),
 command("calc", "int", lng_dec2dec_int, false, "cast decimal(lng) to decimal(int) and check for overflow", args(1,5, arg("",int),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "int", batlng_dec2_int, false, "cast decimal(lng) to int and check for overflow", args(1,4, batarg("",int),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "int", batlng_dec2dec_int, false, "cast decimal(lng) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "lng", bte_dec2_lng, false, "cast decimal(bte) to lng and check for overflow", args(1,3, arg("",lng),arg("scale1",int),arg("v",bte))),
 command("calc", "lng", bte_dec2dec_lng, false, "cast decimal(bte) to decimal(lng) and check for overflow", args(1,5, arg("",lng),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "lng", batbte_dec2_lng, false, "cast decimal(bte) to lng and check for overflow", args(1,4, batarg("",lng),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "lng", batbte_dec2dec_lng, false, "cast decimal(bte) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "lng", sht_dec2_lng, false, "cast decimal(sht) to lng and check for overflow", args(1,3, arg("",lng),arg("scale1",int),arg("v",sht))),
 command("calc", "lng", sht_dec2dec_lng, false, "cast decimal(sht) to decimal(lng) and check for overflow", args(1,5, arg("",lng),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "lng", batsht_dec2_lng, false, "cast decimal(sht) to lng and check for overflow", args(1,4, batarg("",lng),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "lng", batsht_dec2dec_lng, false, "cast decimal(sht) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "lng", int_dec2_lng, false, "cast decimal(int) to lng and check for overflow", args(1,3, arg("",lng),arg("scale1",int),arg("v",int))),
 command("calc", "lng", int_dec2dec_lng, false, "cast decimal(int) to decimal(lng) and check for overflow", args(1,5, arg("",lng),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "lng", batint_dec2_lng, false, "cast decimal(int) to lng and check for overflow", args(1,4, batarg("",lng),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "lng", batint_dec2dec_lng, false, "cast decimal(int) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "lng", lng_dec2_lng, false, "cast decimal(lng) to lng and check for overflow", args(1,3, arg("",lng),arg("scale1",int),arg("v",lng))),
 command("calc", "lng", lng_dec2dec_lng, false, "cast decimal(lng) to decimal(lng) and check for overflow", args(1,5, arg("",lng),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "lng", batlng_dec2_lng, false, "cast decimal(lng) to lng and check for overflow", args(1,4, batarg("",lng),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "lng", batlng_dec2dec_lng, false, "cast decimal(lng) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "flt", bte_dec2_flt, false, "cast decimal(bte) to flt and check for overflow", args(1,3, arg("",flt),arg("scale1",int),arg("v",bte))),
 command("calc", "flt", bte_dec2dec_flt, false, "cast decimal(bte) to decimal(flt) and check for overflow", args(1,5, arg("",flt),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "flt", batbte_dec2_flt, false, "cast decimal(bte) to flt and check for overflow", args(1,4, batarg("",flt),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "flt", batbte_dec2dec_flt, false, "cast decimal(bte) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "flt", sht_dec2_flt, false, "cast decimal(sht) to flt and check for overflow", args(1,3, arg("",flt),arg("scale1",int),arg("v",sht))),
 command("calc", "flt", sht_dec2dec_flt, false, "cast decimal(sht) to decimal(flt) and check for overflow", args(1,5, arg("",flt),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "flt", batsht_dec2_flt, false, "cast decimal(sht) to flt and check for overflow", args(1,4, batarg("",flt),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "flt", batsht_dec2dec_flt, false, "cast decimal(sht) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "flt", int_dec2_flt, false, "cast decimal(int) to flt and check for overflow", args(1,3, arg("",flt),arg("scale1",int),arg("v",int))),
 command("calc", "flt", int_dec2dec_flt, false, "cast decimal(int) to decimal(flt) and check for overflow", args(1,5, arg("",flt),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "flt", batint_dec2_flt, false, "cast decimal(int) to flt and check for overflow", args(1,4, batarg("",flt),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "flt", batint_dec2dec_flt, false, "cast decimal(int) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "flt", lng_dec2_flt, false, "cast decimal(lng) to flt and check for overflow", args(1,3, arg("",flt),arg("scale1",int),arg("v",lng))),
 command("calc", "flt", lng_dec2dec_flt, false, "cast decimal(lng) to decimal(flt) and check for overflow", args(1,5, arg("",flt),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "flt", batlng_dec2_flt, false, "cast decimal(lng) to flt and check for overflow", args(1,4, batarg("",flt),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "flt", batlng_dec2dec_flt, false, "cast decimal(lng) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "dbl", bte_dec2_dbl, false, "cast decimal(bte) to dbl and check for overflow", args(1,3, arg("",dbl),arg("scale1",int),arg("v",bte))),
 command("calc", "dbl", bte_dec2dec_dbl, false, "cast decimal(bte) to decimal(dbl) and check for overflow", args(1,5, arg("",dbl),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "dbl", batbte_dec2_dbl, false, "cast decimal(bte) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "dbl", batbte_dec2dec_dbl, false, "cast decimal(bte) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "dbl", sht_dec2_dbl, false, "cast decimal(sht) to dbl and check for overflow", args(1,3, arg("",dbl),arg("scale1",int),arg("v",sht))),
 command("calc", "dbl", sht_dec2dec_dbl, false, "cast decimal(sht) to decimal(dbl) and check for overflow", args(1,5, arg("",dbl),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "dbl", batsht_dec2_dbl, false, "cast decimal(sht) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "dbl", batsht_dec2dec_dbl, false, "cast decimal(sht) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "dbl", int_dec2_dbl, false, "cast decimal(int) to dbl and check for overflow", args(1,3, arg("",dbl),arg("scale1",int),arg("v",int))),
 command("calc", "dbl", int_dec2dec_dbl, false, "cast decimal(int) to decimal(dbl) and check for overflow", args(1,5, arg("",dbl),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "dbl", batint_dec2_dbl, false, "cast decimal(int) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "dbl", batint_dec2dec_dbl, false, "cast decimal(int) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "dbl", lng_dec2_dbl, false, "cast decimal(lng) to dbl and check for overflow", args(1,3, arg("",dbl),arg("scale1",int),arg("v",lng))),
 command("calc", "dbl", lng_dec2dec_dbl, false, "cast decimal(lng) to decimal(dbl) and check for overflow", args(1,5, arg("",dbl),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "dbl", batlng_dec2_dbl, false, "cast decimal(lng) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "dbl", batlng_dec2dec_dbl, false, "cast decimal(lng) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 /* sql_rank */
 ...
 command("calc", "round", hge_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,5, arg("",hge),arg("v",hge),arg("r",bte),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", hge_bat_round_wrap, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",hge),batarg("v",hge),arg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", hge_bat_round_wrap_cst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,6, batarg("",hge),arg("v",hge),batarg("r",bte),batarg("s",oid),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "round", hge_bat_round_wrap_nocst, false, "round off the decimal v(d,s) to r digits behind the dot (if r < 0, before the dot)", args(1,7, batarg("",hge),batarg("v",hge),batarg("r",bte),batarg("s1",oid),batarg("s2",oid),arg("digits",int),arg("scale",int))),
 ...
 command("calc", "hge", bte_dec2_hge, false, "cast decimal(bte) to hge and check for overflow", args(1,3, arg("",hge),arg("scale1",int),arg("v",bte))),
 command("calc", "hge", bte_dec2dec_hge, false, "cast decimal(bte) to decimal(hge) and check for overflow", args(1,5, arg("",hge),arg("scale1",int),arg("v",bte),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "hge", batbte_dec2_hge, false, "cast decimal(bte) to hge and check for overflow", args(1,4, batarg("",hge),arg("scale1",int),batarg("v",bte),batarg("s",oid))),
 command("batcalc", "hge", batbte_dec2dec_hge, false, "cast decimal(bte) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("scale1",int),batarg("v",bte),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "hge", sht_dec2_hge, false, "cast decimal(sht) to hge and check for overflow", args(1,3, arg("",hge),arg("scale1",int),arg("v",sht))),
 command("calc", "hge", sht_dec2dec_hge, false, "cast decimal(sht) to decimal(hge) and check for overflow", args(1,5, arg("",hge),arg("scale1",int),arg("v",sht),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "hge", batsht_dec2_hge, false, "cast decimal(sht) to hge and check for overflow", args(1,4, batarg("",hge),arg("scale1",int),batarg("v",sht),batarg("s",oid))),
 command("batcalc", "hge", batsht_dec2dec_hge, false, "cast decimal(sht) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("scale1",int),batarg("v",sht),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "hge", int_dec2_hge, false, "cast decimal(int) to hge and check for overflow", args(1,3, arg("",hge),arg("scale1",int),arg("v",int))),
 command("calc", "hge", int_dec2dec_hge, false, "cast decimal(int) to decimal(hge) and check for overflow", args(1,5, arg("",hge),arg("scale1",int),arg("v",int),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "hge", batint_dec2_hge, false, "cast decimal(int) to hge and check for overflow", args(1,4, batarg("",hge),arg("scale1",int),batarg("v",int),batarg("s",oid))),
 command("batcalc", "hge", batint_dec2dec_hge, false, "cast decimal(int) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("scale1",int),batarg("v",int),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "hge", lng_dec2_hge, false, "cast decimal(lng) to hge and check for overflow", args(1,3, arg("",hge),arg("scale1",int),arg("v",lng))),
 command("calc", "hge", lng_dec2dec_hge, false, "cast decimal(lng) to decimal(hge) and check for overflow", args(1,5, arg("",hge),arg("scale1",int),arg("v",lng),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "hge", batlng_dec2_hge, false, "cast decimal(lng) to hge and check for overflow", args(1,4, batarg("",hge),arg("scale1",int),batarg("v",lng),batarg("s",oid))),
 command("batcalc", "hge", batlng_dec2dec_hge, false, "cast decimal(lng) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("scale1",int),batarg("v",lng),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "hge", hge_dec2_hge, false, "cast decimal(hge) to hge and check for overflow", args(1,3, arg("",hge),arg("scale1",int),arg("v",hge))),
 command("calc", "hge", hge_dec2dec_hge, false, "cast decimal(hge) to decimal(hge) and check for overflow", args(1,5, arg("",hge),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "hge", bathge_dec2_hge, false, "cast decimal(hge) to hge and check for overflow", args(1,4, batarg("",hge),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "hge", bathge_dec2dec_hge, false, "cast decimal(hge) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "bte", hge_dec2_bte, false, "cast decimal(hge) to bte and check for overflow", args(1,3, arg("",bte),arg("scale1",int),arg("v",hge))),
 command("calc", "bte", hge_dec2dec_bte, false, "cast decimal(hge) to decimal(bte) and check for overflow", args(1,5, arg("",bte),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "bte", bathge_dec2_bte, false, "cast decimal(hge) to bte and check for overflow", args(1,4, batarg("",bte),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "bte", bathge_dec2dec_bte, false, "cast decimal(hge) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "sht", hge_dec2_sht, false, "cast decimal(hge) to sht and check for overflow", args(1,3, arg("",sht),arg("scale1",int),arg("v",hge))),
 command("calc", "sht", hge_dec2dec_sht, false, "cast decimal(hge) to decimal(sht) and check for overflow", args(1,5, arg("",sht),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "sht", bathge_dec2_sht, false, "cast decimal(hge) to sht and check for overflow", args(1,4, batarg("",sht),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "sht", bathge_dec2dec_sht, false, "cast decimal(hge) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "int", hge_dec2_int, false, "cast decimal(hge) to int and check for overflow", args(1,3, arg("",int),arg("scale1",int),arg("v",hge))),
 command("calc", "int", hge_dec2dec_int, false, "cast decimal(hge) to decimal(int) and check for overflow", args(1,5, arg("",int),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "int", bathge_dec2_int, false, "cast decimal(hge) to int and check for overflow", args(1,4, batarg("",int),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "int", bathge_dec2dec_int, false, "cast decimal(hge) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "lng", hge_dec2_lng, false, "cast decimal(hge) to lng and check for overflow", args(1,3, arg("",lng),arg("scale1",int),arg("v",hge))),
 command("calc", "lng", hge_dec2dec_lng, false, "cast decimal(hge) to decimal(lng) and check for overflow", args(1,5, arg("",lng),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "lng", bathge_dec2_lng, false, "cast decimal(hge) to lng and check for overflow", args(1,4, batarg("",lng),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "lng", bathge_dec2dec_lng, false, "cast decimal(hge) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "flt", hge_dec2_flt, false, "cast decimal(hge) to flt and check for overflow", args(1,3, arg("",flt),arg("scale1",int),arg("v",hge))),
 command("calc", "flt", hge_dec2dec_flt, false, "cast decimal(hge) to decimal(flt) and check for overflow", args(1,5, arg("",flt),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "flt", bathge_dec2_flt, false, "cast decimal(hge) to flt and check for overflow", args(1,4, batarg("",flt),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "flt", bathge_dec2dec_flt, false, "cast decimal(hge) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 ...
 command("calc", "dbl", hge_dec2_dbl, false, "cast decimal(hge) to dbl and check for overflow", args(1,3, arg("",dbl),arg("scale1",int),arg("v",hge))),
 command("calc", "dbl", hge_dec2dec_dbl, false, "cast decimal(hge) to decimal(dbl) and check for overflow", args(1,5, arg("",dbl),arg("scale1",int),arg("v",hge),arg("digits2",int),arg("scale2",int))),
 command("batcalc", "dbl", bathge_dec2_dbl, false, "cast decimal(hge) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("scale1",int),batarg("v",hge),batarg("s",oid))),
 command("batcalc", "dbl", bathge_dec2dec_dbl, false, "cast decimal(hge) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("scale1",int),batarg("v",hge),batarg("s",oid),arg("digits2",int),arg("scale2",int))),
 /* sql_rank_hge */
