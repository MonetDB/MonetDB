...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,3, argany("",1),argany("b",1),arg("t",int))),
 pattern("batsql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,3, batargany("",1),batargany("b",1),arg("t",int))),
 pattern("sql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("p",bit))),
 pattern("batsql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("p",bit))),
 pattern("sql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("o",bit))),
 pattern("batsql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit))),
 pattern("sql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "first_value", SQLfirst_value_global, false, "return the first value of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "first_value", SQLfirst_value, false, "return the first value of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "first_value", SQLfirst_value, false, "return the first value of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "first_value", SQLfirst_value, false, "return the first value of groups", args(1,6, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "first_value", SQLfirst_value, false, "return the first value of groups", args(1,6, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,3, argany("",1),argany("b",1),arg("t",int))),
 pattern("batsql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,3, batargany("",1),batargany("b",1),arg("t",int))),
 pattern("sql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("p",bit))),
 pattern("batsql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("p",bit))),
 pattern("sql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,4, argany("",1),argany("b",1),arg("t",int),arg("o",bit))),
 pattern("batsql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,4, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit))),
 pattern("sql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "last_value", SQLlast_value_global, false, "return the last value of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "last_value", SQLlast_value, false, "return the last value of groups", args(1,5, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "last_value", SQLlast_value, false, "return the last value of groups", args(1,5, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "last_value", SQLlast_value, false, "return the last value of groups", args(1,6, argany("",1),argany("b",1),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "last_value", SQLlast_value, false, "return the last value of groups", args(1,6, batargany("",1),batargany("b",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, argany("",0),argany("b",0),argany("n",1),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),batargany("b",0),argany("n",1),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),argany("b",0),batargany("n",1),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, argany("",0),argany("b",0),argany("n",1),arg("t",int),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),argany("n",1),arg("t",int),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),argany("b",0),batargany("n",1),arg("t",int),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int),batarg("p",bit))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, argany("",0),argany("b",0),argany("n",1),arg("t",int),arg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),argany("n",1),arg("t",int),batarg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),argany("b",0),batargany("n",1),arg("t",int),batarg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int),batarg("o",bit))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, argany("",0),argany("b",0),argany("n",1),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),argany("n",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),argany("b",0),batargany("n",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, argany("",0),argany("b",0),argany("n",1),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),argany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),argany("b",0),batargany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, argany("",0),argany("b",0),argany("n",1),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),batargany("b",0),argany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),argany("b",0),batargany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),batargany("b",0),batargany("n",1),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
