...
static mel_func sql_init_funcs[] = {
 ...
 pattern("batcalc", "identity", PBATSQLidentity, false, "Returns the unique row identitfiers with a candidate list input.", args(2,5, batarg("resb",oid),arg("ns",oid),batargany("b",0),arg("s",oid),batarg("s",oid))),
