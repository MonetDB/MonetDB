...
static mel_func sql_init_funcs[] = {
 ...
 pattern("batcalc", "daytime", str_2time_daytimetz, false, "cast daytime to daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",daytime),arg("digits",int),arg("has_tz",int))),
 pattern("batcalc", "daytime", str_2time_daytimetz, false, "cast daytime to daytime and check for overflow", args(1,5, batarg("",daytime),batarg("v",daytime),batarg("s",cnd),arg("digits",int),arg("has_tz",int))),
 ...
 command("batcalc", "second_interval", hge_batdec2second_interval, false, "cast hge decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",hge),batarg("s",cnd),arg("ek",int),arg("sk",int))),
