...
static mel_func sql_init_funcs[] = {
 ...
 pattern("batsql", "sum", SQLsum_global, false, "return the sum of groups", args(1,3, batarg("",hge),batarg("b",bte))),
 ...
 pattern("batsql", "sum", SQLsum, false, "return the sum of groups", args(1,5, batarg("",hge),batarg("b",bte),batarg("s",lng),batarg("e",lng))),
