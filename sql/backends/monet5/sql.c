...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "tid", SQLtid, false, "Return a column with the valid tuple identifiers associated with the table sname.tname.", args(1,4, batarg("",cnd),arg("mvc",int),arg("sname",str),arg("tname",str))),
 pattern("sql", "tid", SQLtid, false, "Return the tables tid column.", args(1,6, batarg("",cnd),arg("mvc",int),arg("sname",str),arg("tname",str),arg("part_nr",int),arg("nr_parts",int))),
 ...
 pattern("batcalc", "second_interval", bte_batdec2second_interval, false, "cast bte decimal to a second_interval", args(1,5, batarg("",lng),arg("sc",int),batarg("v",bte),arg("ek",int),arg("sk",int))),
 pattern("batcalc", "second_interval", bte_batdec2second_interval, false, "cast bte decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",bte),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", sht_batdec2second_interval, false, "cast sht decimal to a second_interval", args(1,5, batarg("",lng),arg("sc",int),batarg("v",sht),arg("ek",int),arg("sk",int))),
 pattern("batcalc", "second_interval", sht_batdec2second_interval, false, "cast sht decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",sht),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", int_batdec2second_interval, false, "cast int decimal to a second_interval", args(1,5, batarg("",lng),arg("sc",int),batarg("v",int),arg("ek",int),arg("sk",int))),
 pattern("batcalc", "second_interval", int_batdec2second_interval, false, "cast int decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",int),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", lng_batdec2second_interval, false, "cast lng decimal to a second_interval", args(1,5, batarg("",lng),arg("sc",int),batarg("v",lng),arg("ek",int),arg("sk",int))),
 pattern("batcalc", "second_interval", lng_batdec2second_interval, false, "cast lng decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",lng),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "bte", batstr_2dec_bte, false, "cast to dec(bte) and check for overflow", args(1,4, batarg("",bte),batarg("v",str),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "bte", batstr_2dec_bte, false, "cast to dec(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 pattern("batcalc", "sht", batstr_2dec_sht, false, "cast to dec(sht) and check for overflow", args(1,4, batarg("",sht),batarg("v",str),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "sht", batstr_2dec_sht, false, "cast to dec(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 pattern("batcalc", "int", batstr_2dec_int, false, "cast to dec(int) and check for overflow", args(1,4, batarg("",int),batarg("v",str),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "int", batstr_2dec_int, false, "cast to dec(int) and check for overflow", args(1,5, batarg("",int),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 pattern("batcalc", "lng", batstr_2dec_lng, false, "cast to dec(lng) and check for overflow", args(1,4, batarg("",lng),batarg("v",str),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "lng", batstr_2dec_lng, false, "cast to dec(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "timestamp", batstr_2time_timestamp_cand, false, "cast to timestamp and check for overflow", args(1,4, batarg("",timestamp),batarg("v",str),batarg("s",cnd),arg("digits",int))),
 ...
 command("batcalc", "timestamp", batstr_2time_timestamptz_cand, false, "cast to timestamp and check for overflow", args(1,5, batarg("",timestamp),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("has_tz",int))),
 ...
 pattern("batcalc", "timestamp", timestamp_2time_timestamp, false, "cast timestamp to timestamp and check for overflow", args(1,4, batarg("",timestamp),batarg("v",timestamp),batarg("s",cnd),arg("digits",int))),
 ...
 command("batcalc", "daytime", batstr_2time_daytime_cand, false, "cast to daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",str),batarg("s",cnd),arg("digits",int))),
 pattern("batcalc", "daytime", str_2time_daytimetz, false, "cast daytime to daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",str),arg("digits",int),arg("has_tz",int))),
 pattern("batcalc", "daytime", str_2time_daytimetz, false, "cast daytime to daytime and check for overflow", args(1,5, batarg("",daytime),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("has_tz",int))),
 ...
 pattern("batcalc", "daytime", daytime_2time_daytime, false, "cast daytime to daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",daytime),batarg("s",cnd),arg("digits",int))),
 ...
 command("batcalc", "date", batstr_2_date_cand, false, "cast to date", args(1,3, batarg("",date),batarg("v",str),batarg("s",cnd))),
 ...
 command("batcalc", "blob", batstr_2_blob_cand, false, "cast to blob", args(1,3, batarg("",blob),batarg("v",str),batarg("s",cnd))),
 ...
 pattern("batcalc", "second_interval", second_interval_str, false, "cast str to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",str),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast bte to a month_interval and check for overflow", args(1,5, batarg("",int),batarg("v",bte),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast bte to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",bte),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast sht to a month_interval and check for overflow", args(1,5, batarg("",int),batarg("v",sht),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast sht to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",sht),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast int to a month_interval and check for overflow", args(1,5, batarg("",int),batarg("v",int),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast int to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",int),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast lng to a month_interval and check for overflow", args(1,5, batarg("",int),batarg("v",lng),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast lng to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",lng),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval_daytime, false, "cast daytime to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",daytime),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "daytime", second_interval_2_daytime, false, "cast second_interval to a daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",lng),batarg("s",cnd),arg("d",int))),
 ...
 pattern("batcalc", "daytime", timestamp_2_daytime, false, "cast timestamp to a daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",timestamp),batarg("s",cnd),arg("d",int))),
 ...
 pattern("batcalc", "timestamp", date_2_timestamp, false, "cast date to a timestamp and check for overflow", args(1,4, batarg("",timestamp),batarg("v",date),batarg("s",cnd),arg("d",int))),
 ...
 command("batcalc", "bte", batflt_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",flt),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batdbl_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",dbl),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batflt_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",flt),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batdbl_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",dbl),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batflt_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",flt),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batdbl_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",dbl),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batflt_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",flt),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batdbl_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",dbl),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batbte_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batbte_dec2_cand_bte, false, "cast decimal(bte) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "bte", batbte_dec2dec_cand_bte, false, "cast decimal(bte) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "bte", batsht_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batsht_dec2_cand_bte, false, "cast decimal(sht) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "bte", batsht_dec2dec_cand_bte, false, "cast decimal(sht) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "bte", batint_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batint_dec2_cand_bte, false, "cast decimal(int) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "bte", batint_dec2dec_cand_bte, false, "cast decimal(int) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "bte", batlng_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", batlng_dec2_cand_bte, false, "cast decimal(lng) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "bte", batlng_dec2dec_cand_bte, false, "cast decimal(lng) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "sht", batbte_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batbte_dec2_cand_sht, false, "cast decimal(bte) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "sht", batbte_dec2dec_cand_sht, false, "cast decimal(bte) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "sht", batsht_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batsht_dec2_cand_sht, false, "cast decimal(sht) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "sht", batsht_dec2dec_cand_sht, false, "cast decimal(sht) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "sht", batint_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batint_dec2_cand_sht, false, "cast decimal(int) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "sht", batint_dec2dec_cand_sht, false, "cast decimal(int) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "sht", batlng_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", batlng_dec2_cand_sht, false, "cast decimal(lng) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "sht", batlng_dec2dec_cand_sht, false, "cast decimal(lng) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "int", batbte_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batbte_dec2_cand_int, false, "cast decimal(bte) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "int", batbte_dec2dec_cand_int, false, "cast decimal(bte) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "int", batsht_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batsht_dec2_cand_int, false, "cast decimal(sht) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "int", batsht_dec2dec_cand_int, false, "cast decimal(sht) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "int", batint_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batint_dec2_cand_int, false, "cast decimal(int) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "int", batint_dec2dec_cand_int, false, "cast decimal(int) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "int", batlng_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", batlng_dec2_cand_int, false, "cast decimal(lng) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "int", batlng_dec2dec_cand_int, false, "cast decimal(lng) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "lng", batbte_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batbte_dec2_cand_lng, false, "cast decimal(bte) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "lng", batbte_dec2dec_cand_lng, false, "cast decimal(bte) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "lng", batsht_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batsht_dec2_cand_lng, false, "cast decimal(sht) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "lng", batsht_dec2dec_cand_lng, false, "cast decimal(sht) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "lng", batint_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batint_dec2_cand_lng, false, "cast decimal(int) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "lng", batint_dec2dec_cand_lng, false, "cast decimal(int) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "lng", batlng_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", batlng_dec2_cand_lng, false, "cast decimal(lng) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "lng", batlng_dec2dec_cand_lng, false, "cast decimal(lng) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "flt", batbte_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "flt", batbte_dec2_cand_flt, false, "cast decimal(bte) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "flt", batbte_dec2dec_cand_flt, false, "cast decimal(bte) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "flt", batsht_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "flt", batsht_dec2_cand_flt, false, "cast decimal(sht) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "flt", batsht_dec2dec_cand_flt, false, "cast decimal(sht) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "flt", batint_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "flt", batint_dec2_cand_flt, false, "cast decimal(int) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "flt", batint_dec2dec_cand_flt, false, "cast decimal(int) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "flt", batlng_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "flt", batlng_dec2_cand_flt, false, "cast decimal(lng) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "flt", batlng_dec2dec_cand_flt, false, "cast decimal(lng) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "dbl", batbte_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "dbl", batbte_dec2_cand_dbl, false, "cast decimal(bte) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "dbl", batbte_dec2dec_cand_dbl, false, "cast decimal(bte) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "dbl", batsht_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "dbl", batsht_dec2_cand_dbl, false, "cast decimal(sht) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "dbl", batsht_dec2dec_cand_dbl, false, "cast decimal(sht) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "dbl", batint_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "dbl", batint_dec2_cand_dbl, false, "cast decimal(int) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "dbl", batint_dec2dec_cand_dbl, false, "cast decimal(int) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "dbl", batlng_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "dbl", batlng_dec2_cand_dbl, false, "cast decimal(lng) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "dbl", batlng_dec2dec_cand_dbl, false, "cast decimal(lng) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 /* sql_rank */
 ...
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, arg("",bte),arg("b",bte),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, batarg("",bte),batarg("b",bte),batarg("s",lng),batarg("e",lng))),
 ...
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, arg("",sht),arg("b",sht),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, batarg("",sht),batarg("b",sht),batarg("s",lng),batarg("e",lng))),
 ...
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, arg("",int),arg("b",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, batarg("",int),batarg("b",int),batarg("s",lng),batarg("e",lng))),
 ...
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, arg("",lng),arg("b",lng),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, batarg("",lng),batarg("b",lng),batarg("s",lng),batarg("e",lng))),
 ...
 pattern("aggr", "suball", SQLall_grp, false, "if all values in l are equal (per group) return the value, else nil", args(1,6, batargany("",1),batargany("l",1),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "subnull", SQLnil_grp, false, "if any value in l is nil with in a group return true for that group, else false; with candidate list", args(1,6, batarg("",bit),batargany("l",1),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "subanyequal", SQLanyequal_grp, false, "if any value in r is equal to l return true, else if r has nil nil else false; with candidate list", args(1,7, batarg("",bit),batargany("l",1),batargany("r",1),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "subanyequal", SQLanyequal_grp2, false, "if any value in r is equal to l return true, else if r has nil nil else false, except if rid is nil (ie empty) then false; with candidate list", args(1,8, batarg("",bit),batargany("l",1),batargany("r",1),batarg("rid",oid),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "suballnotequal", SQLallnotequal_grp, false, "if all values in r are not equal to l return true, else if r has nil nil else false; with candidate list", args(1,7, batarg("",bit),batargany("l",1),batargany("r",1),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "suballnotequal", SQLallnotequal_grp2, false, "if all values in r are not equal to l return true, else if r has nil nil else false, except if rid is nil (ie empty) then true; with candidate list", args(1,8, batarg("",bit),batargany("l",1),batargany("r",1),batarg("rid",oid),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "subexist", SQLsubexist, false, "", args(1,6, batarg("",bit),batargany("b",0),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 ...
 pattern("aggr", "subnot_exist", SQLsubnot_exist, false, "", args(1,6, batarg("",bit),batargany("b",0),batarg("g",oid),batarg("e",oid),batarg("s",cnd),arg("no_nil",bit))),
 /* wlr */
 ...
 pattern("batcalc", "second_interval", hge_batdec2second_interval, false, "cast hge decimal to a second_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",hge),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "hge", batstr_2dec_hge, false, "cast to dec(hge) and check for overflow", args(1,4, batarg("",hge),batarg("v",str),arg("digits",int),arg("scale",int))),
 pattern("batcalc", "hge", batstr_2dec_hge, false, "cast to dec(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",str),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast hge to a month_interval and check for overflow", args(1,5, batarg("",int),batarg("v",hge),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast hge to a second_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",hge),batarg("s",cnd),arg("ek",int),arg("sk",int))),
 /* sql_decimal_hge */
 ...
 command("batcalc", "hge", batflt_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",flt),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batdbl_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",dbl),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batbte_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",bte),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batbte_dec2_cand_hge, false, "cast decimal(bte) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",bte),batarg("s",cnd))),
 ...
 command("batcalc", "hge", batbte_dec2dec_cand_hge, false, "cast decimal(bte) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",bte),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "hge", batsht_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",sht),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batsht_dec2_cand_hge, false, "cast decimal(sht) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",sht),batarg("s",cnd))),
 ...
 command("batcalc", "hge", batsht_dec2dec_cand_hge, false, "cast decimal(sht) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",sht),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "hge", batint_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",int),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batint_dec2_cand_hge, false, "cast decimal(int) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",int),batarg("s",cnd))),
 ...
 command("batcalc", "hge", batint_dec2dec_cand_hge, false, "cast decimal(int) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",int),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "hge", batlng_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",lng),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", batlng_dec2_cand_hge, false, "cast decimal(lng) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",lng),batarg("s",cnd))),
 ...
 command("batcalc", "hge", batlng_dec2dec_cand_hge, false, "cast decimal(lng) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",lng),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "hge", bathge_num2dec_cand_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "hge", bathge_dec2_cand_hge, false, "cast decimal(hge) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "hge", bathge_dec2dec_cand_hge, false, "cast decimal(hge) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "bte", bathge_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "bte", bathge_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,4, batarg("",bte),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "bte", bathge_num2dec_cand_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "bte", bathge_dec2_cand_bte, false, "cast decimal(hge) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "bte", bathge_dec2dec_cand_bte, false, "cast decimal(hge) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "sht", bathge_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "sht", bathge_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,4, batarg("",sht),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "sht", bathge_num2dec_cand_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "sht", bathge_dec2_cand_sht, false, "cast decimal(hge) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "sht", bathge_dec2dec_cand_sht, false, "cast decimal(hge) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "int", bathge_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "int", bathge_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,4, batarg("",int),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "int", bathge_num2dec_cand_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "int", bathge_dec2_cand_int, false, "cast decimal(hge) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "int", bathge_dec2dec_cand_int, false, "cast decimal(hge) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "lng", bathge_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "lng", bathge_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,4, batarg("",lng),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "lng", bathge_num2dec_cand_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "lng", bathge_dec2_cand_lng, false, "cast decimal(hge) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "lng", bathge_dec2dec_cand_lng, false, "cast decimal(hge) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "flt", bathge_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "flt", bathge_num2dec_flt, false, "cast number to decimal(flt) and check for overflow", args(1,4, batarg("",flt),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "flt", bathge_num2dec_cand_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "flt", bathge_dec2_cand_flt, false, "cast decimal(hge) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "flt", bathge_dec2dec_cand_flt, false, "cast decimal(hge) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 ...
 command("batcalc", "dbl", bathge_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 command("batcalc", "dbl", bathge_num2dec_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,4, batarg("",dbl),batarg("v",hge),arg("digits",int),arg("scale",int))),
 command("batcalc", "dbl", bathge_num2dec_cand_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",hge),batarg("s",cnd),arg("digits",int),arg("scale",int))),
 ...
 command("batcalc", "dbl", bathge_dec2_cand_dbl, false, "cast decimal(hge) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",hge),batarg("s",cnd))),
 ...
 command("batcalc", "dbl", bathge_dec2dec_cand_dbl, false, "cast decimal(hge) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",hge),batarg("s",cnd),arg("d2",int),arg("s2",int))),
 /* sql_rank_hge */
 ...
 pattern("sql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, arg("",hge),arg("b",hge),arg("s",lng),arg("e",lng))),
 pattern("batsql", "avg", SQLavginteger, false, "return the average of groups", args(1,4, batarg("",hge),batarg("b",hge),batarg("s",lng),batarg("e",lng))),
