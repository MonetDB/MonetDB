...
static mel_func sql_init_funcs[] = {
 ...
 command("batcalc", "bte", batnil_ce_2dec_bte, false, "cast to dec(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",oid),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batstr_ce_2dec_bte, false, "cast to dec(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",str),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batnil_ce_2dec_sht, false, "cast to dec(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",oid),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batstr_ce_2dec_sht, false, "cast to dec(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",str),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batnil_ce_2dec_int, false, "cast to dec(int) and check for overflow", args(1,5, batarg("",int),batarg("v",oid),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batstr_ce_2dec_int, false, "cast to dec(int) and check for overflow", args(1,5, batarg("",int),batarg("v",str),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batnil_ce_2dec_lng, false, "cast to dec(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",oid),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batstr_ce_2dec_lng, false, "cast to dec(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",str),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 pattern("batcalc", "daytime", nil_2time_daytime, false, "cast to daytime and check for overflow", args(1,4, batarg("",daytime),batarg("v",oid),arg("digits",int),batarg("r",msk))),
 ...
 pattern("batcalc", "date", nil_2_date, false, "cast to date", args(1,3, batarg("",date),batarg("v",oid),batarg("r",msk))),
 ...
 command("batcalc", "date", batstr_ce_2_date, false, "cast to date", args(1,3, batarg("",date),batarg("v",str),batarg("r",msk))),
 ...
 command("batcalc", "blob", batstr_ce_2_blob, false, "cast to blob", args(1,3, batarg("",blob),batarg("v",str),batarg("r",msk))),
 ...
 pattern("batcalc", "str", SQLbatstr_cast, false, "cast to string and check for overflow", args(1,8, batarg("",str),arg("eclass",int),arg("d1",int),arg("s1",int),arg("has_tz",int),batargany("v",1),arg("digits",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batflt_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",flt),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batdbl_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",dbl),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batflt_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",flt),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batdbl_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",dbl),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batflt_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",flt),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batdbl_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",dbl),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batflt_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",flt),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batdbl_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",dbl),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batbte_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batbte_ce_dec2_bte, false, "cast decimal(bte) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "bte", batbte_ce_dec2dec_bte, false, "cast decimal(bte) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batsht_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batsht_ce_dec2_bte, false, "cast decimal(sht) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "bte", batsht_ce_dec2dec_bte, false, "cast decimal(sht) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batint_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batint_ce_dec2_bte, false, "cast decimal(int) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batint_ce_dec2dec_bte, false, "cast decimal(int) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batlng_ce_num2dec_bte, false, "cast number to decimal(bte) and check for overflow", args(1,5, batarg("",bte),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", batlng_ce_dec2_bte, false, "cast decimal(lng) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "bte", batlng_ce_dec2dec_bte, false, "cast decimal(lng) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batbte_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batbte_ce_dec2_sht, false, "cast decimal(bte) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "sht", batbte_ce_dec2dec_sht, false, "cast decimal(bte) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batsht_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batsht_ce_dec2_sht, false, "cast decimal(sht) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "sht", batsht_ce_dec2dec_sht, false, "cast decimal(sht) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batint_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batint_ce_dec2_sht, false, "cast decimal(int) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batint_ce_dec2dec_sht, false, "cast decimal(int) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batlng_ce_num2dec_sht, false, "cast number to decimal(sht) and check for overflow", args(1,5, batarg("",sht),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", batlng_ce_dec2_sht, false, "cast decimal(lng) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "sht", batlng_ce_dec2dec_sht, false, "cast decimal(lng) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batbte_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batbte_ce_dec2_int, false, "cast decimal(bte) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "int", batbte_ce_dec2dec_int, false, "cast decimal(bte) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batsht_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batsht_ce_dec2_int, false, "cast decimal(sht) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "int", batsht_ce_dec2dec_int, false, "cast decimal(sht) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batint_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batint_ce_dec2_int, false, "cast decimal(int) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batint_ce_dec2dec_int, false, "cast decimal(int) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batlng_ce_num2dec_int, false, "cast number to decimal(int) and check for overflow", args(1,5, batarg("",int),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "int", batlng_ce_dec2_int, false, "cast decimal(lng) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "int", batlng_ce_dec2dec_int, false, "cast decimal(lng) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batbte_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batbte_ce_dec2_lng, false, "cast decimal(bte) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "lng", batbte_ce_dec2dec_lng, false, "cast decimal(bte) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batsht_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batsht_ce_dec2_lng, false, "cast decimal(sht) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "lng", batsht_ce_dec2dec_lng, false, "cast decimal(sht) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batint_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batint_ce_dec2_lng, false, "cast decimal(int) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batint_ce_dec2dec_lng, false, "cast decimal(int) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batlng_ce_num2dec_lng, false, "cast number to decimal(lng) and check for overflow", args(1,5, batarg("",lng),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", batlng_ce_dec2_lng, false, "cast decimal(lng) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "lng", batlng_ce_dec2dec_lng, false, "cast decimal(lng) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batbte_ce_num2dec_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batbte_ce_dec2_flt, false, "cast decimal(bte) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "flt", batbte_ce_dec2dec_flt, false, "cast decimal(bte) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batsht_ce_num2dec_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batsht_ce_dec2_flt, false, "cast decimal(sht) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "flt", batsht_ce_dec2dec_flt, false, "cast decimal(sht) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batint_ce_num2dec_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batint_ce_dec2_flt, false, "cast decimal(int) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batint_ce_dec2dec_flt, false, "cast decimal(int) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batlng_ce_num2dec_flt, false, "cast number to decimal(flt) and check for overflow", args(1,5, batarg("",flt),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", batlng_ce_dec2_flt, false, "cast decimal(lng) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "flt", batlng_ce_dec2dec_flt, false, "cast decimal(lng) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batbte_ce_num2dec_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batbte_ce_dec2_dbl, false, "cast decimal(bte) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batbte_ce_dec2dec_dbl, false, "cast decimal(bte) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batsht_ce_num2dec_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batsht_ce_dec2_dbl, false, "cast decimal(sht) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batsht_ce_dec2dec_dbl, false, "cast decimal(sht) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batint_ce_num2dec_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batint_ce_dec2_dbl, false, "cast decimal(int) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batint_ce_dec2dec_dbl, false, "cast decimal(int) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batlng_ce_num2dec_dbl, false, "cast number to decimal(dbl) and check for overflow", args(1,5, batarg("",dbl),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batlng_ce_dec2_dbl, false, "cast decimal(lng) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "dbl", batlng_ce_dec2dec_dbl, false, "cast decimal(lng) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 /* sql_rank */
 ...
 command("batcalc", "hge", batnil_ce_2dec_hge, false, "cast to dec(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",void),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batstr_ce_2dec_hge, false, "cast to dec(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",str),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batflt_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",flt),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batdbl_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",dbl),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batbte_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",bte),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batbte_ce_dec2_hge, false, "cast decimal(bte) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",bte),batarg("r",msk))),
 ...
 command("batcalc", "hge", batbte_ce_dec2dec_hge, false, "cast decimal(bte) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",bte),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batsht_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",sht),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batsht_ce_dec2_hge, false, "cast decimal(sht) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",sht),batarg("r",msk))),
 ...
 command("batcalc", "hge", batsht_ce_dec2dec_hge, false, "cast decimal(sht) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",sht),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batint_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",int),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batint_ce_dec2_hge, false, "cast decimal(int) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batint_ce_dec2dec_hge, false, "cast decimal(int) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",int),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batlng_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",lng),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", batlng_ce_dec2_hge, false, "cast decimal(lng) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",lng),batarg("r",msk))),
 ...
 command("batcalc", "hge", batlng_ce_dec2dec_hge, false, "cast decimal(lng) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",lng),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", bathge_ce_num2dec_hge, false, "cast number to decimal(hge) and check for overflow", args(1,5, batarg("",hge),batarg("v",hge),arg("digits",int),arg("scale",int),batarg("r",msk))),
 ...
 command("batcalc", "hge", bathge_ce_dec2_hge, false, "cast decimal(hge) to hge and check for overflow", args(1,4, batarg("",hge),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "hge", bathge_ce_dec2dec_hge, false, "cast decimal(hge) to decimal(hge) and check for overflow", args(1,6, batarg("",hge),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "bte", bathge_ce_dec2_bte, false, "cast decimal(hge) to bte and check for overflow", args(1,4, batarg("",bte),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "bte", bathge_ce_dec2dec_bte, false, "cast decimal(hge) to decimal(bte) and check for overflow", args(1,6, batarg("",bte),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "sht", bathge_ce_dec2_sht, false, "cast decimal(hge) to sht and check for overflow", args(1,4, batarg("",sht),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "sht", bathge_ce_dec2dec_sht, false, "cast decimal(hge) to decimal(sht) and check for overflow", args(1,6, batarg("",sht),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "int", bathge_ce_dec2_int, false, "cast decimal(hge) to int and check for overflow", args(1,4, batarg("",int),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "int", bathge_ce_dec2dec_int, false, "cast decimal(hge) to decimal(int) and check for overflow", args(1,6, batarg("",int),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "lng", bathge_ce_dec2_lng, false, "cast decimal(hge) to lng and check for overflow", args(1,4, batarg("",lng),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "lng", bathge_ce_dec2dec_lng, false, "cast decimal(hge) to decimal(lng) and check for overflow", args(1,6, batarg("",lng),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "flt", bathge_ce_dec2_flt, false, "cast decimal(hge) to flt and check for overflow", args(1,4, batarg("",flt),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "flt", bathge_ce_dec2dec_flt, false, "cast decimal(hge) to decimal(flt) and check for overflow", args(1,6, batarg("",flt),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 ...
 command("batcalc", "dbl", bathge_ce_dec2_dbl, false, "cast decimal(hge) to dbl and check for overflow", args(1,4, batarg("",dbl),arg("s1",int),batarg("v",hge),batarg("r",msk))),
 ...
 command("batcalc", "dbl", bathge_ce_dec2dec_dbl, false, "cast decimal(hge) to decimal(dbl) and check for overflow", args(1,6, batarg("",dbl),arg("s1",int),batarg("v",hge),arg("d2",int),arg("s2",int),batarg("r",msk))),
 /* sql_rank_hge */
