...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "importColumn", mvc_bin_import_column_wrap, false, "Import a column from the given file", args(2, 6, batargany("", 0),arg("", oid), arg("type",str),arg("path",str),arg("onclient",int),arg("nrows",oid))),
