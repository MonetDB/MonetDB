...
static mel_func sql_init_funcs[] = {
 ...
 command("batcalc", "second_interval", hge_batdec2second_interval, false, "cast hge decimal to a second_cand_interval", args(1,6, batarg("",lng),arg("sc",int),batarg("v",hge),batarg("s",oid),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "month_interval", month_interval, false, "cast hge to a month_cand_interval and check for overflow", args(1,5, batarg("",int),batarg("v",hge),batarg("s",oid),arg("ek",int),arg("sk",int))),
 ...
 pattern("batcalc", "second_interval", second_interval, false, "cast hge to a second_cand_interval and check for overflow", args(1,5, batarg("",lng),batarg("v",hge),batarg("s",oid),arg("ek",int),arg("sk",int))),
 /* sql_decimal_hge */
