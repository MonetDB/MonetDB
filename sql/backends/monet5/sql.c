...
static mel_func sql_init_funcs[] = {
 ...
 pattern("dict", "thetaselect", DICTselect, false, "thetaselect on a dictionary", args(1, 6, batarg("r0", oid), batargany("lo", 0), batarg("lc", oid), batargany("lv", 1), argany("val",1), arg("op", str))),
