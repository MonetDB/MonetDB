...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "setVariable", setVariable, true, "Set the value of a session variable", args(1,4, arg("",int),arg("mvc",int),arg("varname",str),argany("value",1))),
 pattern("sql", "getVariable", getVariable, false, "Get the value of a session variable", args(1,3, argany("",1),arg("mvc",int),arg("varname",str))),
 ...
 pattern("sql", "sql_variables", sql_variables, false, "return the table with session variables", args(1,1, batarg("",str))),
 ...
 */
 ...
 command("calc", "bte", nil_2num_bte, false, "cast to bte and check for overflow", args(1,3, arg("",bte),arg("v",void),arg("digits",int))),
 ...
 command("batcalc", "bte", batnil_2num_bte, false, "cast to bte and check for overflow", args(1,3, batarg("",bte),batarg("v",oid),arg("digits",int))),
 ...
 command("calc", "bte", str_2num_bte, false, "cast to bte and check for overflow", args(1,3, arg("",bte),arg("v",str),arg("digits",int))),
 ...
 command("batcalc", "bte", batstr_2num_bte, false, "cast to bte and check for overflow", args(1,3, batarg("",bte),batarg("v",str),arg("digits",int))),
 ...
 command("calc", "sht", nil_2num_sht, false, "cast to sht and check for overflow", args(1,3, arg("",sht),arg("v",void),arg("digits",int))),
 ...
 command("batcalc", "sht", batnil_2num_sht, false, "cast to sht and check for overflow", args(1,3, batarg("",sht),batarg("v",oid),arg("digits",int))),
 ...
 command("calc", "sht", str_2num_sht, false, "cast to sht and check for overflow", args(1,3, arg("",sht),arg("v",str),arg("digits",int))),
 ...
 command("batcalc", "sht", batstr_2num_sht, false, "cast to sht and check for overflow", args(1,3, batarg("",sht),batarg("v",str),arg("digits",int))),
 ...
 command("calc", "int", nil_2num_int, false, "cast to int and check for overflow", args(1,3, arg("",int),arg("v",void),arg("digits",int))),
 ...
 command("batcalc", "int", batnil_2num_int, false, "cast to int and check for overflow", args(1,3, batarg("",int),batarg("v",oid),arg("digits",int))),
 ...
 command("calc", "int", str_2num_int, false, "cast to int and check for overflow", args(1,3, arg("",int),arg("v",str),arg("digits",int))),
 ...
 command("batcalc", "int", batstr_2num_int, false, "cast to int and check for overflow", args(1,3, batarg("",int),batarg("v",str),arg("digits",int))),
 ...
 command("calc", "lng", nil_2num_lng, false, "cast to lng and check for overflow", args(1,3, arg("",lng),arg("v",void),arg("digits",int))),
 ...
 command("batcalc", "lng", batnil_2num_lng, false, "cast to lng and check for overflow", args(1,3, batarg("",lng),batarg("v",oid),arg("digits",int))),
 ...
 command("calc", "lng", str_2num_lng, false, "cast to lng and check for overflow", args(1,3, arg("",lng),arg("v",str),arg("digits",int))),
 ...
 command("batcalc", "lng", batstr_2num_lng, false, "cast to lng and check for overflow", args(1,3, batarg("",lng),batarg("v",str),arg("digits",int))),
 ...
 command("calc", "timestamp", nil_2_timestamp, false, "Cast to timestamp", args(1,2, arg("",timestamp),arg("v",void))),
 ...
 command("batcalc", "timestamp", batnil_2_timestamp, false, "Cast to timestamp", args(1,2, batarg("",timestamp),batarg("v",oid))),
 ...
 command("calc", "timestamp", str_2_timestamp, false, "Cast to timestamp", args(1,2, arg("",timestamp),arg("v",str))),
 ...
 command("batcalc", "timestamp", batstr_2_timestamp, false, "Cast to timestamp", args(1,2, batarg("",timestamp),batarg("v",str))),
 ...
 command("calc", "daytime", nil_2_daytime, false, "Cast to daytime", args(1,2, arg("",daytime),arg("v",void))),
 ...
 command("batcalc", "daytime", batnil_2_daytime, false, "Cast to daytime", args(1,2, batarg("",daytime),batarg("v",oid))),
 ...
 command("calc", "daytime", str_2_daytime, false, "Cast to daytime", args(1,2, arg("",daytime),arg("v",str))),
 ...
 command("batcalc", "daytime", batstr_2_daytime, false, "Cast to daytime", args(1,2, batarg("",daytime),batarg("v",str))),
 ...
 command("calc", "hge", nil_2num_hge, false, "cast to hge and check for overflow", args(1,3, arg("",hge),arg("v",void),arg("digits",int))),
 ...
 command("batcalc", "hge", batnil_2num_hge, false, "cast to hge and check for overflow", args(1,3, batarg("",hge),batarg("v",void),arg("digits",int))),
 ...
 command("calc", "hge", str_2num_hge, false, "cast to hge and check for overflow", args(1,3, arg("",hge),arg("v",str),arg("digits",int))),
 ...
 command("batcalc", "hge", batstr_2num_hge, false, "cast to hge and check for overflow", args(1,3, batarg("",hge),batarg("v",str),arg("digits",int))),
