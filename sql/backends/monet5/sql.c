...
// command("aggr", "exist", ALGexist, false, "", args(1,3, arg("",bit),batargany("b",2),argany("h",1))),
 command("aggr", "exist", SQLexist, false, "", args(1,2, arg("",bit),batargany("b",0))),
 pattern("aggr", "exist", SQLexist_val, false, "", args(1,2, arg("",bit),argany("v",0))),
 command("aggr", "subexist", SQLsubexist, false, "", args(1,5, batarg("",bit),batargany("b",0),batarg("g",oid),batarg("e",oid),arg("no_nil",bit))),
 command("aggr", "not_exist", SQLnot_exist, false, "", args(1,2, arg("",bit),batargany("b",0))),
 pattern("aggr", "not_exist", SQLnot_exist_val, false, "", args(1,2, arg("",bit),argany("v",0))),
 command("aggr", "subnot_exist", SQLsubnot_exist, false, "", args(1,5, batarg("",bit),batargany("b",0),batarg("g",oid),batarg("e",oid),arg("no_nil",bit))),
 /* wlr */
