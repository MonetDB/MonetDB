...
static mel_func sql_init_funcs[] = {
 ...
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, argany("",0),argany("b",0),arg("n",lng),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,4, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, argany("",0),argany("b",0),arg("n",lng),arg("t",int),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int),batarg("p",bit))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, argany("",0),argany("b",0),arg("n",lng),arg("t",int),arg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int),batarg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int),batarg("o",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,5, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int),batarg("o",bit))),
 pattern("sql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, argany("",0),argany("b",0),arg("n",lng),arg("t",int),arg("o",bit),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value_global, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int),batarg("o",bit),batarg("p",bit))),
 pattern("sql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, argany("",0),argany("b",0),arg("n",lng),arg("t",int),arg("s",lng),arg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,6, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng))),
 pattern("sql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, argany("",0),argany("b",0),arg("n",lng),arg("t",int),arg("s",lng),arg("e",lng),arg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),batargany("b",0),arg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),argany("b",0),batarg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
 pattern("batsql", "nth_value", SQLnth_value, false, "return the nth value of each group", args(1,7, batargany("",0),batargany("b",0),batarg("n",lng),arg("t",int),batarg("s",lng),batarg("e",lng),batarg("p",bit))),
