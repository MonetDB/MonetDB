...
sql5_export str T1##_dec2_##T2(Client ctx, T2 *res, const int *s1, const T1 *v);	\
sql5_export str bat##T1##_dec2_##T2(Client ctx, bat *res, const int *s1, const bat *v, const bat *sid); \
sql5_export str T1##_dec2dec_##T2(Client ctx, T2 *res, const int *S1, const T1 *v, const int *d2, const int *S2); \
sql5_export str bat##T1##_dec2dec_##T2(Client ctx, bat *res, const int *S1, const bat *v, const bat *sid, const int *d2, const int *S2); \
sql5_export str T1##_num2dec_##T2(Client ctx, T2 *res, const T1 *v, const int *d2, const int *s2); \
sql5_export str bat##T1##_num2dec_##T2(Client ctx, bat *res, const bat *v, const bat *sid, const int *d2, const int *s2);
