...
sql5_export Symbol backend_dumpproc(backend *be, Client c, cq *q, stmt *s, sql_rel *rel);
sql5_export void backend_callinline(backend *be, Client c, stmt *s, sql_rel *rel);
