...
sql5_export str SQLwindowstartbound(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci);
sql5_export str SQLwindowendbound(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr pci);
