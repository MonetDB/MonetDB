...
pattern sql.first_value(b:any_1, p:bit, o:bit, unit:int, s:int, e:int, excl:int) :any_1
address SQLfirst_value
comment "return the first value of groups";

pattern batsql.first_value(b:bat[:any_1], p:any_2, o:any_3, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLfirst_value
comment "return the first value of groups";


pattern sql.last_value(b:any_1, p:bit, o:bit, unit:int, s:int, e:int, excl:int) :any_1
address SQLlast_value
comment "return the last value of groups";

pattern batsql.last_value(b:bat[:any_1], p:any_2, o:any_3, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLlast_value
comment "return the last value of groups";
...
pattern sql.count(b:any_1, ignils:bit, p:bit, o:bit, unit:int, s:int, e:int, excl:int) :lng
address SQLcount
comment "return count of groups";

pattern batsql.count(b:bat[:any_1], ignils:bit, p:any_2, o:any_3, unit:int, s:int, e:int, exl:int) :bat[:lng]
address SQLcount
comment "return count of groups";
...
pattern batsql.lag(b:bat[:any_1], p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLlag
comment "return the value in the previous row in the partition or NULL if non existent";
...
pattern sql.lead(b:any_1, p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :any_1
address SQLlead
comment "return the value in the next row in the partition or NULL if non existent";

pattern batsql.lead(b:bat[:any_1], p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLlead
comment "return the value in the next row in the partition or NULL if non existent";


pattern sql.lead(b:any_1, l:any_2, p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :any_1
address SQLlead
comment "return the value in the next 'l' row in the partition or NULL if non existent";

pattern batsql.lead(b:bat[:any_1], l:any_2, p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLlead
comment "return the value in the next 'l' row in the partition or NULL if non existent";

pattern sql.lead(b:any_1, l:bat[:any_2], p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :any_1
address SQLlead
comment "return the value in the next 'l' row in the partition or NULL if non existent";

pattern batsql.lead(b:bat[:any_1], l:bat[:any_2], p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :bat[:any_1]
address SQLlead
comment "return the value in the next 'l' row in the partition or NULL if non existent";
...
pattern sql.nth_value(b:any_1, n:any_2, p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :any_1
...
pattern sql.nth_value(b:any_1, n:bat[:any_2], p:any_3, o:any_4, unit:int, s:int, e:int, exl:int) :any_1
address SQLnth_value
comment "return the nth value of each group";
