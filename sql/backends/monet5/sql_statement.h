...
extern stmt *stmt_outerselect(backend *be, stmt *li, stmt *ri, stmt *l, stmt *r, int cmp, bool is_semantics);
extern stmt *stmt_markselect(backend *be, stmt *li, stmt *mask, stmt *l, stmt *r, int cmp);
