...
extern stmt *stmt_project_(backend *be, int sel, int del, int ins, stmt *c, stmt *all);
 ...
 */
extern stmt *stmt_limit(backend *sa, stmt *c, stmt *piv, stmt *gid, stmt *offset, stmt *limit, int distinct, int dir, int nullslast, int last, int order, int pipeline);
