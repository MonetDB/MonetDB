...
extern stmt *stmt_bat(backend *be, sql_column *c, int access);
extern stmt *stmt_idxbat(backend *be, sql_idx *i, int access);
extern stmt *stmt_tid(backend *be, sql_table *t);
