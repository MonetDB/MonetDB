...
extern sql_table *sql_trans_create_table(sql_trans *tr, sql_schema *s, char *name, char *query, bit system, int persistence, int commit_action, int sz, int location);
extern sql_table *sql_trans_create_view(sql_trans *tr, sql_schema *s, char *name, char *sql, bit system, int location);
extern sql_table *sql_trans_create_generated(sql_trans *tr, sql_schema *s, char *name, char *sql, bit system, int location);
