...
sqlbat_export sql_type * sql_trans_create_type( sql_trans *tr, sql_module *m, 
...
sqlbat_export sql_table *sql_trans_create_table(sql_trans * tr, sql_schema *s, 
		char *name, bit system, bit persists, bit clear, int sz);
