create table aircraft (aircraft_code char(3) NOT NULL,aircraft_type char(64) NOT NULL,engines decimal(1) NOT NULL,category char(10) NOT NULL,wide_body char(3) NOT NULL,wing_span float(6,2) NOT NULL,length1 float(6,2) NOT NULL,weight integer(7) NOT NULL,capacity decimal(3) NOT NULL,pay_load integer(7) NOT NULL,cruising_speed decimal(5) NOT NULL,range_miles decimal(5) NOT NULL,pressurized char(3) NOT NULL,PRIMARY KEY (aircraft_code));
...
create table flight_fare (flight_code integer(8) NOT NULL,fare_code char(8) NOT NULL,PRIMARY KEY (flight_code, fare_code));
...
create table stop1 (flight_code integer(8) NOT NULL,stop_number decimal(1) NOT NULL,stop_flight integer(8) NOT NULL,PRIMARY KEY (flight_code, stop_number));
