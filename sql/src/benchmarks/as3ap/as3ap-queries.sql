...
insert into updates values(6000, 0, 60000, 39997.90, 50005.00, 50005.00, date '11/10/85', 'CONTROLLER', 'ALICE IN WONDERLAND', 'UNIVERSITY OF ILLINOIS AT CHICAGO ', 'Krabbe');
delete from updates where k=6000 and i=0;
insert into updates values(5005, 5005, 50005, 50005.00, 50005.00, 50005.00, date '1/1/88', 'CONTROLLER', 'ALICE IN WONDERLAND', 'UNIVERSITY OF ILLINOIS AT CHICAGO ', 'Krabbe');
update updates set k= -5000 where k=5005;
delete from updates where k= -5000;
insert into updates values(1000000001, 50005, 50005, 50005.00, 50005.00, 50005.00, date '1/1/88', 'CONTROLLER', 'ALICE IN WONDERLAND', 'UNIVERSITY OF ILLINOIS AT CHICAGO ', 'Krabbe');
