...
/**
 * A PrepareResultMessage provides information to the client on what and
 * how much data it should supply in an ExecutePreparedMessage.
 *
 * @author Fabian Groffen <Fabian.Groffen>
 */
public class PrepareResultMessage extends MCLMessage {
	...
	/**
	 * Constructs an empty PrepareResultMessage.  The sentences need to
	 * be added using the addSentence() method.  This constructor is
	 * suitable when reconstructing messages from a stream.
	 */
	public PrepareResultMessage() {
		// nothing has to be done here
		sentences = new MCLSentence[9];
	}

	/**
	 * Constructs a filled PrepareResultMessage.  All MCL metadata
	 * information is supplied and stored in this PrepareResultMessage.
	 *
	...
	public PrepareResultMessage(
		...
		sentences[2] = new MCLSentence('$', "ctype", ctype);
	}
	...
	public void addColumn(String[] columns) throws MCLException {
		...
		if (sentences[3] != null) throw
			new MCLException("column header already set");

		column = columns;
		sentences[3] = new MCLSentence(MCLSentence.METADATA, "column", columns);
	}
	...
	public void addTable(String[] tables) throws MCLException {
		...
		table = tables;
		sentences[4] = new MCLSentence(MCLSentence.METADATA, "table", tables);
	}
	...
	public void addSchema(String[] schemas) throws MCLException {
		...
		schema = schemas;
		sentences[5] = new MCLSentence(MCLSentence.METADATA, "schema", schemas);
	}
	...
	public void addTypes(String[] types) throws MCLException {
		...
		type = types;
		sentences[6] = new MCLSentence(MCLSentence.METADATA, "type", types);
	}
