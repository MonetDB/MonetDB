...
create table t2 (id int, age int, PRIMARY KEY (ID), FOREIGN KEY(id) as REFERENCE (t1)) ON DELETE CASCADE;

create table t3 (id int, day int, FOREIGN KEY(id) as REFERENCE (t2)) ON DELETE CASCADE;
