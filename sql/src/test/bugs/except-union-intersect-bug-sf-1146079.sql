...
START TRANSACTION;
SELECT class FROM a EXCEPT ALL SELECT 16; -- all but 16
SELECT class FROM a UNION ALL SELECT 16; -- all plus 16
SELECT class FROM a INTERSECT ALL SELECT 16; -- a few 16s
ROLLBACK;
...
SELECT class FROM a EXCEPT ALL SELECT class FROM b; -- dups
SELECT * FROM a UNION ALL SELECT * FROM b; -- a + b
SELECT * FROM a INTERSECT ALL SELECT * FROM b; -- first 50% of a
SELECT class FROM a INTERSECT ALL SELECT class FROM b; -- dups
ROLLBACK;
