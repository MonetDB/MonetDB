...
SELECT * FROM Employee WHERE NOT BirthDate <>                 DATE '1970-01-01'; -- fixme
...
SELECT * FROM Employee WHERE NOT BirthDate NOT BETWEEN DATE '1970-01-01' AND DATE '1970-01-01'; -- fixme
