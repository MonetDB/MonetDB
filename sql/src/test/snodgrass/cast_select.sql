...
SELECT CAST( TIMESTAMP '1997-07-23 12:34:56.123' AS TIME(6) ) = TIME '12:34:56.123000'; -- fixme
SELECT CAST( TIMESTAMP '1997-07-23 12:34:56.123' AS DATE ) = DATE '1997-07-23';
SELECT CAST( DATE '1997-01-01' AS TIMESTAMP(4)) = '1997-01-01 00:00:00.0000'; -- fixme

-- intervals
SELECT CAST('2' AS INTERVAL MONTH );
SELECT CAST('3-7' AS INTERVAL MONTH );  -- err: wrong
