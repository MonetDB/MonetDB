...
--  999.6666666 is allowed and it should be rounded to 888.67
--
--
...
insert into test values (-123.12);
      -- should be rounded to 123.12
insert into test values (123.123);
      -- should be rounded to -123.12
insert into test values (-123.123);
      -- should be rounded to 123.13
...
insert into test values (1234);
      -- a '.00' decimal part is assumed here
insert into test values (-1234);
      -- a '.00' decimal part is assumed here
