...
update hundredbug set si=-5000 where i=0;
update hundred set sibug=-500000000 where i=0;
...
insert into updates values(6000, 60000, 39997.90, 50005.00, 50005.00, '11/10/85', 'CONTROLLER', 'ALICE IN WONDERLAND', 'UNIVERSITY OF ILLINOIS AT CHICAGO ', 'Krabbe');
...
delete from updatesbug where k=5005;
insert into updates values(5005, 5005, 50005, 50005.00, 50005.00, 50005.00, '1/1/88', 'CONTROLLER', 'ALICE IN WONDERLAND', 'UNIVERSITY OF ILLINOIS AT CHICAGO ', 'Krabbe');
