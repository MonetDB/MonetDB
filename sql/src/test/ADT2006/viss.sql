...
INSERT INTO "witness"('Patrick Mulshaw', '4:00AM', 'suspicious', 'Watchman, old man, I believe somebody is murdered down the street.');
INSERT INTO "witness"('Emily Walter', '2:00 A.M.', 'Foreigner aged 37, dark beard and moustache. Wearing short dark jacket, dark vest and trousers, black scarf and black felt hat.', 'Asked witness to enter the backyard of 29 Hanbury Street.');
INSERT INTO "witness"('Elizabeth Long', '5:30 A.M.', 'Dark complexion, brown deerstalker hat, possibly a dark overcoat. Aged over 40, somewhat taller than Chapman. A foreigner of "shabby genteel."', '"Will you?"');
INSERT INTO "witness"('J. Best and John Gardner', '11 P.M.', '5''5" tall, English, black moustache, sandy eyelashes, weak, wearing a morning suit and a billycock hat."', '');
INSERT INTO "witness"('William Marshall', '11:45 P.M.', 'Small, black coat, dark trousers, middle aged, round cap with a small sailor-like peak. 5''6", stout, appearance of a clerk. No moustache, no gloves, with a cutaway coat.', '"You would say anything but your prayers." Spoken mildly, with an English accent, and in an educated manner.');
INSERT INTO "witness"('Matthew Packer', '12:00 - 12:30 P.M.', 'Aged 25-30, (5''7"), long black coat buttoned up, soft felt hawker hat, broad shoulders. Maybe a young clerk, frock coat, no gloves.', 'Quiet in speaking, with a rough voice');
INSERT INTO "witness"('P.C. William Smith', '12:30 A.M.', 'Aged 28, cleanshaven and respectable appearance, 5''7", hard dark felt deerstalker hat, dark clothes. Carrying a newspaper parcel 18 x 7 inches.', '');
INSERT INTO "witness"('James Brown', '12:45 A.M.', '5''7", stout, long black diagonal coat which reached almost to his heels.', '');
INSERT INTO "witness"('Israel Schwartz', '12:45 A.M.', 'First man: Aged 30, 5''5", brown haired, fair complexion, small brown moustache, full face, broad shoulders, dark jacket and trousers, black cap with peak. Second man: Aged 35, 5''11", fresh complexion, light brown hair, dark overcoat, old black hard felt hat with a wide brim, clay pipe.', '"Lipski!"');
INSERT INTO "witness"('Joseph Lawende', '1:30 A.M', 'Aged 30, 5''7", fair complexion, brown moustache, salt-and-pepper coat, red neckerchief, grey peaked cloth cap. Sailor-like.', '');
INSERT INTO "witness"('James Blenkinsop', '1:30 A.M.', 'Well-dressed.', '"Have you seen a man and a woman go through here?"');
INSERT INTO "witness"('Mary Ann Cox', '11:45 P.M.', 'Short, stout man, shabbily dressed. Billycock hat, blotchy face, carroty moustache, holding quart can of beer', '');
INSERT INTO "witness"('Mary Miniter', 'between 10:30 and 11:00', 'About 32 years of age. Five feet, eight inches tall. Slim build. Long, sharp nose. Heavy moustache of light color. Foreign in appearance, possibly German. Dark-brown cutaway coat. Black trousers. Old black derby hat with dented crown.', '');
INSERT INTO "witness"('George Hutchinson', '2:00 A.M.', 'Aged 34-35, 5''6", pale complexion, dark hair, slight moustached curled at each end, long dark coat, collar cuffs of astrakhan, dark jacket underneath. Light waistcoat, thick gold chain with a red stone seal, dark trousers and button boots, gaiters, white buttons. White shirt, black tie fastened with a horseshoe pin. Dark hat, turned down in middle. Red kerchief. Jewish and respectable in appearance.', '');
INSERT INTO "witness"('Ada Wilson', '', 'a man of about 30 years of age, 5ft 6ins in height, with a sunburnt face and a fair moustache. He was wearing a dark coat, light trousers and a wideawake hat.', '');
INSERT INTO "witness"('Rose Bierman', '', 'a young fair man with a light coat on', '');
INSERT INTO "witness"('"Jumbo" Friday', '', '', '');
INSERT INTO "witness"('Duncan Campnell', '', '', '');
INSERT INTO "witness"('George Chapman', '', '', '');
...
INSERT INTO "timeline" VALUES('Mary Ann Walker', 'She is seen leaving the Frying Pan Public House at the corner of Brick Lane and Thrawl Street. She returns to the lodging house at 18 Thrawl Street.', '12:30 AM'); 
...
CREATE TABLE "suspect" (
	...
	"picture"			varchar(80),
	"notes"				varchar(999),
	"victim"       		varchar(40) REFERENCES "victim"
);
...
INSERT INTO "suspect" VALUES('Severin Klosowski (George Chapman)', 'http://www.casebook.org/images/suspect_klos.jpg', 'there are some reasons in favour of and some against suspecting him', 'Carrie Brown');
...
SELECT date-of-birth FROM victim WHERE length is not NULL;
...
SELECT name FROM witness WHERE eyes in (SELECT eyes FROM victim WHERE eyes is NULL OR eyes='unknown');


SELECT name FROM victim WHERE name in (SELECT name FROM suspect is NULL);
