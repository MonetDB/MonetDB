...
create function array_tavg(val int,    dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (a double) external name "array".avg;
create function array_tavg(val real,   dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (a real)   external name "array".avg;
create function array_tavg(val double, dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (a double) external name "array".avg;

create function array_tsum(val int,    dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (s bigint) external name "array".sum;
create function array_tsum(val real,   dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (s double) external name "array".sum;
create function array_tsum(val double, dim1 int, offsets1 int, size1 int, dim2 int, offsets2 int, size2 int) returns table (s double) external name "array".sum;
