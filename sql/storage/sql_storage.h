...
typedef int (*proprec_col_fptr) (sql_trans *tr, sql_column *c, bool *nonil, bool *unique, ValPtr min, ValPtr max);
...
extern int sql_trans_col_stats(sql_trans *tr, sql_column *col, bool *nonil, bool *unique, ValPtr min, ValPtr max);
