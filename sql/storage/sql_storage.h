...
extern sql_schema *sql_trans_rename_schema(sql_trans *tr, int id, const char *new_name);
...
extern sql_table *sql_trans_rename_table(sql_trans *tr, sql_schema *s, int id, const char *new_name);
