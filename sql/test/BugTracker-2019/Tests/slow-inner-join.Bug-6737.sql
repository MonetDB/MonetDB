...
insert into monet1_test select value "Id", value "key", value "value" from generate_series(1,6000);
insert into monet2_test select value "Id", value "key", value "value" from generate_series(1,2000);
