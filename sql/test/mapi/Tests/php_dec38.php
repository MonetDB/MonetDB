...
$res = monetdb_query('CREATE TABLE php_dec38 (d0 DECIMAL(38,0), d19 DECIMAL(38,19));') or die(monetdb_last_error());
while ( $row = monetdb_fetch_assoc($res) ) { print_r($row); }

$res = monetdb_query('INSERT INTO php_dec38 VALUES (12345678901234567899876543210987654321, 1234567890123456789.9876543210987654321);') or die(monetdb_last_error());
while ( $row = monetdb_fetch_assoc($res) ) { print_r($row); }
