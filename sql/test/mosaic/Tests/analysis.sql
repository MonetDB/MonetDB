...
select technique, factor from mosaic.analysis('sys', 'tmp4', 'i') order by technique, factor desc;
...
select technique, factor from mosaic.analysis('sys', 'tmp4', 'i', 'linear, runlength') order by technique, factor desc;
