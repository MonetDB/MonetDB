    ...
    with process.server(mapiport=node1_port, dbname='node1',
        ...
        with process.server(mapiport=node2_port, dbname='node2',
            ...
            with process.server(mapiport=node3_port, dbname='node3',
                ...
                node3_conn = pymonetdb.connect(database='node3', port=node3_port, autocommit=True)
                ...
                node1_cur.execute("CREATE REMOTE TABLE s2 (s_pk INT, i INT) on 'mapi:monetdb://localhost:{}/node2'".format(node2_port))
                ...
                node2_cur.execute("CREATE REMOTE TABLE s1 (s_pk INT, i INT) on 'mapi:monetdb://localhost:{}/node1'".format(node1_port))
                ...
                node3_cur.execute("CREATE REMOTE TABLE s1 (s_pk INT, i INT) on 'mapi:monetdb://localhost:{}/node1'".format(node1_port))
                node3_cur.execute("ALTER TABLE s1 ADD CONSTRAINT s1_pk PRIMARY KEY (s_pk)")
                node3_cur.execute("CREATE REMOTE TABLE s2 (s_pk INT, i INT) on 'mapi:monetdb://localhost:{}/node2'".format(node2_port))
                ...
                node3_cur.execute("CREATE REMOTE TABLE t1 (t_pk INT, t_fk INT, s VARCHAR(10)) on 'mapi:monetdb://localhost:{}/node1'".format(node1_port))
                ...
                node3_cur.execute("CREATE REMOTE TABLE t2 (t_pk INT, t_fk INT, s VARCHAR(10)) on 'mapi:monetdb://localhost:{}/node2'".format(node2_port))
