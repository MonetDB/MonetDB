...
with tempfile.TemporaryDirectory() as farm_dir:
    ...
    with process.server(mapiport=myport, dbname='db1',
        ...
        with SQLTestCase() as tc:
            ...
            tc.execute("INSERT INTO testme VALUES (5, 'one'), (12, 'two'), (13, 'three'), (15, 'four'), (NULL, 'five');").assertSucceeded()
            tc.execute("INSERT INTO anothertest VALUES (11, 'one'), (12, 'two'), (13, 'three'), (15, 'four');").assertSucceeded()
    ...
    with process.server(mapiport=myport, dbname='db1',
        ...
        with SQLTestCase() as tc:
            ...
            tc.execute("INSERT INTO upsme VALUES (NULL, 'one');").assertSucceeded()
    ...
    with process.server(mapiport=myport, dbname='db1',
        ...
        with SQLTestCase() as tc:
            tc.connect(username="monetdb", password="monetdb", port=myport, database='db1')
            tc.execute("INSERT INTO upsme VALUES (10, 'two'), (40, 'three'), (NULL, 'four');").assertSucceeded()
            tc.execute("INSERT INTO subtable3 VALUES (NULL, 'five');").assertSucceeded()
