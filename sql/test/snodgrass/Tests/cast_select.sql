...
SELECT CAST( 103 AS INTERVAL MONTH ) = INTERVAL '103' MONTH; --error, not possible
...
SELECT CAST( CAST( 7430400 AS INTERVAL SECOND ) AS INTERVAL DAY TO SECOND ) = INTERVAL '86 00:00:00' DAY TO SECOND; --error, not possible
SELECT CAST(DATE '1997-01-01' AS CHARACTER(10)) = '1997-01-01';
SELECT CAST(INTERVAL '7430400' SECOND AS BIGINT) = 7430400; --error, not possible
SELECT CAST(CAST(INTERVAL '2064:00:00' HOUR TO SECOND AS INTERVAL SECOND) AS BIGINT) = 7430400; --error, not possible
