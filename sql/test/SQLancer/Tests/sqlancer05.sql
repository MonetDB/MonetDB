...
INSERT INTO t2(c0) VALUES (CASE WHEN TRUE THEN TIMESTAMP '1970-01-11 13:04:02' END BETWEEN TIMESTAMP '1970-01-05 05:04:47' AND TIMESTAMP '1970-01-01 20:00:35');
INSERT INTO t2(c0) VALUES(NOT ((CASE WHEN TRUE THEN TIMESTAMP '1970-01-11 13:04:02' ELSE TIMESTAMP '1970-01-02 23:25:05' END) 
NOT BETWEEN SYMMETRIC (COALESCE(TIMESTAMP '1969-12-30 12:07:22', TIMESTAMP '1970-01-05 05:04:47')) AND (CASE WHEN TRUE THEN TIMESTAMP '1970-01-01 20:00:35' END)));
ROLLBACK;
