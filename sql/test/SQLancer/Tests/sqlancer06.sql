...
SELECT t1.c2 FROM t2 RIGHT OUTER JOIN t1 ON (t2.c1) WHERE (SELECT t1.c2 FROM t1, t2) = ALL(SELECT t0.c2 FROM t0, t2);
	...
	-- NULL
	-- 20:32:11
SELECT t1.c2 FROM t2 RIGHT OUTER JOIN t1 ON NOT (t2.c1) WHERE (((((((0.9842272043385978) NOT IN (1721458345))OR(t2.c0)))AND((t2.c0) BETWEEN ASYMMETRIC (t2.c0) AND 
((SELECT ALL t2.c0 FROM t2, t0 WHERE t2.c1)))))OR((SELECT t1.c2 FROM t1, t2) = ALL(SELECT ALL t0.c2 FROM t0, t1, t2)));
	-- NULL
	-- NULL
	-- 20:32:11
SELECT CAST(SUM(count) AS BIGINT) FROM (SELECT CAST((((((((0.9842272043385978) NOT IN (1721458345))OR(t2.c0)))AND((t2.c0) BETWEEN ASYMMETRIC (t2.c0) AND 
