...
INSERT INTO t0 VALUES ('Qnec4v3|', INTERVAL '2071616848' SECOND), ('B', INTERVAL '2052804659' SECOND), (NULL, INTERVAL '2052029418' SECOND);
UPDATE t0 SET c1 = INTERVAL '916700621' SECOND; --error, unique constraint violated
DROP TABLE t0;
