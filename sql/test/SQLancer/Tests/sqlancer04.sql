...
CREATE TABLE IF NOT EXISTS t0(c0 boolean  UNIQUE PRIMARY KEY, c1 DOUBLE , UNIQUE(c1, c0));
...
INSERT INTO t1(c1, c0) VALUES(0.3, FALSE), (0.5, true), (0.00000000000000000, true), (497053888, false), (1, true), (4, true);
DELETE FROM t1 WHERE NOT least(t1.c0, t1.c0);
UPDATE t1 SET c1 = (CAST(((0.17)>>(0.12)) AS INT)) WHERE t1.c1 BETWEEN SYMMETRIC 3 AND 7 + t1.c1;
DROP TABLE t1;
DROP TABLE t0;
