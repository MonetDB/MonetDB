...
merge into t2 using (select * from t1) as t1 on (((((values (false), (false)))and("isauuid"(r'AJr1G'))))or(exists ((select distinct l2t2.c2 from t0 as l2t0, t2 as l2t2 where false group by l2t2.c2, l2t2.c2, 
