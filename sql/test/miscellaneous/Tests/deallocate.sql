...
select "parameter", "type", "digits", "scale", "schema", "table", "column" from prepared_statements_args; --only 1
select "prep"."statement", "parameter", "type", "digits", "scale", "schema", "table", "column" 
...
select "parameter", "type", "digits", "scale", "schema", "table", "column" from prepared_statements_args; --empty
