CREATE ARRAY hrit_c039_image_array (x INTEGER DIMENSION[3], y INTEGER DIMENSION[3], v SMALLINT DEFAULT 0);
CREATE ARRAY hrit_c108_image_array (x INTEGER DIMENSION[3], y INTEGER DIMENSION[3], v SMALLINT DEFAULT 0);
