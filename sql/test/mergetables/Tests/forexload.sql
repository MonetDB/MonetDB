...
CREATE TABLE day1 ( clk timestamp, currency string, ts timestamp, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );
CREATE TABLE day1stage ( clk bigint, currency string, ts bigint, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );
...
CREATE TABLE day2 ( clk timestamp, currency string, ts timestamp, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );
CREATE TABLE day2stage ( clk bigint, currency string, ts bigint, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );
...
CREATE TABLE day3 ( clk timestamp, currency string, ts timestamp, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );

CREATE MERGE TABLE forex ( clk bigint, currency string, ts bigint, bid decimal(12,6), offer decimal(12,6), "open"  decimal(12,6), spread decimal(12,6) );
...
INSERT INTO day3 VALUES(1413267181000, 'EUR/USD', 1413267182327, 1.271910, 1.271990, 1.271950, 0.000080);
INSERT INTO day3 VALUES(1413267181000, 'USD/JPY', 1413267181647, 107.114000,107.121000,107.117500,0.007000);
INSERT INTO day3 VALUES(1413267181000, 'GBP/USD', 1413267182048, 1.606870, 1.606980, 1.606925, 0.000110);
INSERT INTO day3 VALUES(1413267181000, 'EUR/GBP', 1413267181968, 0.791490, 0.791600, 0.791545, 0.000110);
INSERT INTO day3 VALUES(1413267181000, 'USD/CHF', 1413267182041, 0.950350, 0.950460, 0.950405, 0.000110);
INSERT INTO day3 VALUES(1413267181000, 'EUR/JPY', 1413267182406, 136.241000,136.253000,136.247000,0.012000);
INSERT INTO day3 VALUES(1413267181000, 'EUR/CHF', 1413267181950, 1.208770, 1.208950, 1.208860, 0.000180);
INSERT INTO day3 VALUES(1413267181000, 'USD/CAD', 1413267181830, 1.121120, 1.121230, 1.121175, 0.000110);
INSERT INTO day3 VALUES(1413267181000, 'AUD/USD', 1413267181549, 0.878730, 0.878810, 0.878770, 0.000080);
INSERT INTO day3 VALUES(1413267181000, 'GBP/JPY', 1413267181618, 172.116000,172.138000,172.127000,0.022000);
