...
with process.server(args=['--clean-BBP'],
    ...
    with process.client(lang='sql',
                        ...
                        stderr=process.PIPE,
                        server=srv) as clt:
        cltout, clterr = clt.communicate('drop function if exists testschema.pyapi01;\ndrop function if exists testschema.pyapi02;\ndrop function if exists testschema.rapi01;\ndrop function if exists testschema.rapi02;\ndrop function if exists testschema.capi00;\ndrop function if exists testschema.pyapi10_mult;\ndrop aggregate if exists testschema.aggrmedian;\n')
