...
with SQLTestCase() as mdb1:
    with SQLTestCase() as mdb2:
        ...
        mdb1.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,)])
        mdb1.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,)])
        mdb1.execute('commit;').assertSucceeded()
        mdb1.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,)])
        mdb2.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,)])
        mdb1.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,)])
        ...
        mdb1.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,)])
        mdb2.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb1.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,)])
        mdb2.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb1.execute('commit;').assertSucceeded()
        mdb2.execute('commit;').assertSucceeded()
        mdb1.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb2.execute('SELECT a from myfunc()').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb1.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb2.execute('SELECT a from myview').assertDataResultMatch([(1,),(2,),(3,),(4,)])
        mdb1.execute('start transaction;').assertSucceeded()
