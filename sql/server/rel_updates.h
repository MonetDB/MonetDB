...
extern sql_rel *rel_delete(sql_allocator *sa, sql_rel *t, sql_rel *deletes, int multi);
extern sql_rel *rel_truncate(sql_allocator *sa, sql_rel *t, int drop_action, int check_identity, int multi);
