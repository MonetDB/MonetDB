...
extern list *_rel_projections(mvc *sql, sql_rel *rel, sql_alias *tname, int settname , int intern, int basecol, bool bound);
sql_export list *rel_projections(mvc *sql, sql_rel *rel, sql_alias *tname, int settname , int intern);
