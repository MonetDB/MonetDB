...
bool
can_split_select(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_cycle == 0 && gp->opt_level == 1 && gp->cnt[op_select];
}
...
bool
can_remove_redundant_join(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_cycle == 0 && gp->opt_level == 1 && (gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_join] || gp->cnt[op_semi] || gp->cnt[op_anti]);
}
...
bool
can_optimize_select_and_joins_bottomup(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti] || gp->cnt[op_select]);
}
...
bool
can_optimize_joins(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti]);
}
...
bool
can_join_order(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && !gp->cnt[op_update] && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti]);
}
...
bool
can_optimize_semi_and_anti(visitor *v, global_props *gp)
{
...
bool
can_optimize_select_and_joins_topdown(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti] || gp->cnt[op_select]);
}
...
bool
can_push_func_and_select_down(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti] || gp->cnt[op_select]);
}
...
bool
can_push_select_up(visitor *v, global_props *gp)
{
	(void) v;
	return gp->opt_level == 1 && gp->cnt[op_select] && (gp->cnt[op_join] || gp->cnt[op_left] || gp->cnt[op_right] || gp->cnt[op_full] || gp->cnt[op_semi] || gp->cnt[op_anti]);
}
