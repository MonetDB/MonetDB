...
/*dependency control*/
extern void mvc_create_dependency(mvc *m, sql_base *b, sqlid depend_id, sql_dependency depend_type);
extern void mvc_create_dependencies(mvc *m, list *blist, sqlid depend_id, sql_dependency dep_type);
