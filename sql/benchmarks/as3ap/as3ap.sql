/*database as3ap;
*/
create table uniques(k integer  not null, i integer  not null, si integer , f float not null, d double not null, decim integer  not null, date integer  not null, code char(10)  not null, name char(20)  not null, address string not null, fill char(6)  not null);
create table hundred(k integer  not null, i integer  not null, si integer , f float  not null, d double  not null, decim integer  not null, date integer  not null, code char(10)  not null, name char(20)  not null, address string not null, fill char(6)  not null);
create table tenpct(k integer  not null, i integer  not null, si integer , f float  not null, d double  not null, decim integer  not null, date integer  not null, code char(10)  not null, name char(20)  not null, address string not null, fill char(6)  not null);
create table updates(k integer  not null, i integer  not null, si integer , f float  not null, d double  not null, decim integer  not null, date integer  not null, code char(10)  not null, name char(20)  not null, address string not null, fill char(6)  not null);
...
create table _AS3AP_join_3_cl(us integer , ud integer , hs integer , hd integer , ts integer , td integer );
...
create table _AS3AP_join_3_ncl(us integer , ud integer , hs integer , hd integer , ts integer , td integer );
...
create view _AS3AP_subtotal_report as select avg(si), min(si), max(si), max(date), min(date), count(distinct name), count(name), code, i from reportview where decim>980000000 group by code, i;
...
create table _AS3AP_join_4_ncl(ud integer, hd integer , td integer , upd integer );
