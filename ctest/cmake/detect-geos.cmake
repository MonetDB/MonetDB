...
configure_file(test_detect_geos.c.in
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_geos.c
  @ONLY)

add_executable(test_detect_geos)
target_sources(test_detect_geos
  PRIVATE
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_geos.c)
target_link_libraries(test_detect_geos
  PRIVATE
  monetdb_config_header)
add_test(testDetectGeos test_detect_geos)
