...
configure_file(test_detect_xml.c.in
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_xml.c
  @ONLY)

add_executable(test_detect_xml)
target_sources(test_detect_xml
  PRIVATE
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_xml.c)
target_link_libraries(test_detect_xml
  PRIVATE
  monetdb_config_header)
add_test(testDetectXml test_detect_xml)
