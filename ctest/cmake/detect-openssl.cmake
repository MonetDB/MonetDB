...
configure_file(test_detect_openssl.c.in
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_openssl.c
  @ONLY)

add_executable(test_detect_openssl)
target_sources(test_detect_openssl
  PRIVATE
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_openssl.c)
target_link_libraries(test_detect_openssl
  PRIVATE
  monetdb_config_header)
add_test(testDetectPcre test_detect_openssl)
