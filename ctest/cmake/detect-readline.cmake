...
configure_file(test_detect_readline.c.in
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_readline.c
  @ONLY)

add_executable(test_detect_readline)
target_sources(test_detect_readline
  PRIVATE
  ${CMAKE_CURRENT_BINARY_DIR}/test_detect_readline.c)
target_link_libraries(test_detect_readline
  PRIVATE
  monetdb_config_header)
add_test(testDetectReadline test_detect_readline)
