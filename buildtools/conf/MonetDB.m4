...
MONETDB_PREFIX="."
if test "x$1" = "x"; then
  MONETDB_REQUIRED_VERSION="1.36.0"
  #                         ^^^^^^
...
CLIENTS_PREFIX="."
if test "x$1" = "x"; then
  CLIENTS_REQUIRED_VERSION="1.36.0"
  #                         ^^^^^^
  # Maintained via vertoo. Please don't modify by hand!
  # Contact MonetDB-developers@lists.sourceforge.net for details and/or assistance.
else
...
if test "x$have_clients" != xno; then
  ...
  *) MPATH="$withval/bin:$PATH";;
  ...
  if test "x$have_clients" = "xincluded"; then
    have_clients=yes
    CLIENTS_CFLAGS=""
    CLIENTS_INCLUDEDIR="\$(top_srcdir)/../../MonetDB-client/clients/src"
...
MONETDB4_PREFIX="."
if test "x$1" = "x"; then
  MONETDB4_REQUIRED_VERSION="4.36.0"
  #                          ^^^^^^
  # Maintained via vertoo. Please don't modify by hand!
  # Contact MonetDB-developers@lists.sourceforge.net for details and/or assistance.
else
...
MONETDB5_XML_LIB=""
if test "x$1" = "x"; then
  MONETDB5_REQUIRED_VERSION="5.18.0"
  #                          ^^^^^
  # Maintained via vertoo. Please don't modify by hand!
  # Contact MonetDB-developers@lists.sourceforge.net for details and/or assistance.
else
