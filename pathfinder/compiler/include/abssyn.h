...
enum PFptype_t {
    ...
    , p_option           =  70
    , p_or               =  71  /**< or */
    , p_ord_ret          =  72  /**< `order by'/`return' in FLWOR clauses */
    , p_orderby          =  73  /**< FLWOR `orderby' clause */
    , p_ordered          =  74  /**< keyword `ordered {...}' */
    , p_ordering_mode    =  75  /**< ordering mode declaration */
    , p_orderspecs       =  76  /**< list of order specifiers (in FLWORs) */
    , p_param            =  77  /**< (formal) function parameter */
    , p_params           =  78  /**< list of (formal) function parameters */
    , p_pi               =  79  /**< <?...?> content */
    , p_plus             =  80  /**< binary + */
    , p_pragma           =  81  /**< pragma */
    , p_pragmas          =  82  /**< list of pragmas */
    , p_pred             =  83  /**< e1[e2] (predicate) */
    , p_range            =  84  /**< to (range) */
    , p_req_name         =  85  /**< required name */
    , p_req_ty           =  86  /**< required type */
    , p_root             =  87  /**< / (document root) */
    , p_schm_ats         =  88  /**< list of `at StringLit' in schema imp. */
    , p_schm_attr        =  89  /**< `schema-attribute()' test */
    , p_schm_elem        =  90  /**< `schema-element()' test */
    , p_schm_imp         =  91  /**< schema import */
    , p_seq_ty           =  92  /**< sequence type */
    , p_some             =  93  /**< some (existential quantifier) */
    , p_step             =  94  /**< axis step */
    , p_tag              =  95  /**< (fixed) tag name */
    , p_text             =  96  /**< XML text node constructor */
    , p_then_else        =  97  /**< `then' and `else' in if-then-else */
    , p_treat            =  98  /**< treat as */
    , p_typeswitch       =  99  /**< typeswitch */
    , p_uminus           = 100  /**< unary - */
    , p_union            = 101  /**< union */
    , p_unordered        = 102  /**< keyword `unordered {...}' */
    , p_uplus            = 103  /**< unary + */
    , p_val_eq           = 104  /**< eq (value equality) */
    , p_val_ge           = 105  /**< ge (value greter than or equal) */
    , p_val_gt           = 106  /**< gt (value greater than) */
    , p_val_le           = 107  /**< le (value less than or equal) */
    , p_val_lt           = 108  /**< lt (value less than) */
    , p_val_ne           = 109  /**< ne (value inequality) */
    , p_validate         = 110  /**< validate */
    , p_var              = 111  /**< ``real'' scoped variable */
    , p_var_decl         = 112  /**< variable declaration */
    , p_var_type         = 113  /**< variable/type combination */
    , p_varref           = 114  /**< variable reference (no scoping yet) */
    , p_vars             = 115  /**< parent of two variables in FLWORs */
    , p_where            = 116  /**< FLWOR `where' clause */
    , p_boundspc_decl    = 117  /**< xmlspace declaration */
    , p_revalid          = 118  /**< revalidation declaration (XQ Updt) */
    , p_insert           = 119  /**< "do insert" expression (XQ Updt) */
    , p_delete           = 120  /**< "do delete" expression (XQ Updt) */
    , p_replace          = 121  /**< "do replace" expression (XQ Updt) */
    , p_rename           = 122  /**< "do rename" expression (XQ Updt) */
    , p_transform        = 123  /**< "transform copy $" expressions (XQ Updt) */
    , p_modify           = 124  /**< modify and return parts of transform */
    , p_transbinds       = 125  /**< variable bindings in a "transform" */
    , p_stmt_ty          = 126  /**< "item" type `stmt' (funct. decls.) */

    /* Pathfinder extension: recursion */
    , p_recursion        = 127  /**< "with $xx seeded by..." expression */
    , p_seed             = 128  /**< seed and return expr of a recursive expr */

    /* Pathfinder extension: XRPC */
    , p_xrpc             = 129  /**< XRPC: "execute at" */
