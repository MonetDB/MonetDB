...
SQLhelp sqlhelp1[] = {
	...
	{"EXPLAIN",
	 ...
	 "\twhere step is LOGICAL UNNEST | LOGICAL REWRITE | LOGICAL PHYSICAL [posint] [posint] | PHYSICAL",
	 NULL,
	 "Plain EXPLAIN defaults to logical plan.\n"
	 "Use LOGICAL UNNEST|LOGICAL REWRITE|LOGICAL PHYSICAL|PHYSICAL to specify compilation step to show.\n"
