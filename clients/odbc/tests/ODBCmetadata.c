...
/* run actual metadata query tests */
	...
	compareResult(stmt, ret, "EXPLAIN PHYSICAL SELECT * from odbctst.\"LINES\"",
		...
		"\n"
		"    X_37:int := sql.resultSet(X_38:bat[:str], X_39:bat[:str], X_40:bat[:str], X_41:bat[:int], X_42:bat[:int], X_43:bat[:int], X_33:bat[:int], X_34:bat[:int], X_35:bat[:int], X_36:bat[:int]);\n"
		"end user.main;\n"
		"\n\n"
	    :
		"Resultset with 1 columns\n"
