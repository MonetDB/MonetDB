...
main(int argc, char **argv)
{
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ALTER_DOMAIN");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ALTER_TABLE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ASYNC_DBC_FUNCTIONS");
	printf("SQL_ASYNC_DBC_FUNCTIONS:");
	if (i & SQL_ASYNC_DBC_CAPABLE)
		printf(" SQL_ASYNC_DBC_CAPABLE");
	if (i & SQL_ASYNC_DBC_NOT_CAPABLE)
		printf(" SQL_ASYNC_DBC_NOT_CAPABLE");
	printf("\n");
#endif

	ret = SQLGetInfo(dbc, SQL_ASYNC_MODE, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ASYNC_MODE");
	printf("SQL_ASYNC_MODE:");
	if (i & SQL_AM_CONNECTION)
		printf(" SQL_AM_CONNECTION");
	if (i & SQL_AM_STATEMENT)
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ASYNC_NOTIFICATION");
	printf("SQL_ASYNC_NOTIFICATION:");
	if (i & SQL_ASYNC_NOTIFICATION_CAPABLE)
		printf(" SQL_ASYNC_NOTIFICATION_CAPABLE");
	if (i & SQL_ASYNC_NOTIFICATION_NOT_CAPABLE)
		printf(" SQL_ASYNC_NOTIFICATION_NOT_CAPABLE");
	printf("\n");
#endif

	ret = SQLGetInfo(dbc, SQL_BATCH_ROW_COUNT, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_BATCH_ROW_COUNT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_BATCH_SUPPORT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_BOOKMARK_PERSISTENCE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CATALOG_LOCATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_COLLATION_SEQ");
	printf("SQL_COLLATION_SEQ: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_COLUMN_ALIAS, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_COLUMN_ALIAS");
	printf("SQL_COLUMN_ALIAS: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_CONCAT_NULL_BEHAVIOR, &s, sizeof(s), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONCAT_NULL_BEHAVIOR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_BIGINT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_BINARY");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_BIT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_CHAR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_DATE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_DECIMAL");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_DOUBLE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_FLOAT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_INTEGER");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_INTERVAL_DAY_TIME");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_INTERVAL_YEAR_MONTH");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_LONGVARBINARY");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_LONGVARCHAR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_NUMERIC");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_REAL");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_SMALLINT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_TIME");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_TIMESTAMP");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_TINYINT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_VARBINARY");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CONVERT_VARCHAR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CORRELATION_NAME");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_ASSERTION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_CHARACTER_SET");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_COLLATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_DOMAIN");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_SCHEMA");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_TABLE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_TRANSLATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CREATE_VIEW");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CURSOR_COMMIT_BEHAVIOR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CURSOR_ROLLBACK_BEHAVIOR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_CURSOR_SENSITIVITY");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DBMS_NAME");
	printf("SQL_DBMS_NAME: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DBMS_VER, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DBMS_VER");
	printf("#SQL_DBMS_VER: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DDL_INDEX, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DDL_INDEX");
	printf("SQL_DDL_INDEX: %u\n", i);

	ret = SQLGetInfo(dbc, SQL_DEFAULT_TXN_ISOLATION, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DEFAULT_TXN_ISOLATION");
	printf("SQL_DEFAULT_TXN_ISOLATION: %u\n", i);

	ret = SQLGetInfo(dbc, SQL_DESCRIBE_PARAMETER, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DESCRIBE_PARAMETER");
	printf("SQL_DESCRIBE_PARAMETER: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DM_VER, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DM_VER");
	printf("SQL_DM_VER: %.*s\n", resultlen, str);

#ifdef SQL_DRIVER_AWARE_POOLING_SUPPORTED
	ret = SQLGetInfo(dbc, SQL_DRIVER_AWARE_POOLING_SUPPORTED, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_AWARE_POOLING_SUPPORTED");
	printf("SQL_DRIVER_AWARE_POOLING_SUPPORTED: %u\n", i);
#endif

	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_HDBC");

	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_HDESC");

	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_HENV");

	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_HLIB");

	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_HSTMT");

	ret = SQLGetInfo(dbc, SQL_DRIVER_NAME, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_NAME");
	printf("SQL_DRIVER_NAME: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DRIVER_ODBC_VER, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_ODBC_VER");
	printf("SQL_DRIVER_ODBC_VER: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DRIVER_VER, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DRIVER_VER");
	printf("#SQL_DRIVER_VER: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_DROP_ASSERTION, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_ASSERTION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_CHARACTER_SET");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_COLLATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_DOMAIN");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_SCHEMA");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_TABLE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_TRANSLATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DROP_VIEW");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DYNAMIC_CURSOR_ATTRIBUTES1");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_DYNAMIC_CURSOR_ATTRIBUTES2");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_EXPRESSIONS_IN_ORDERBY");
	printf("SQL_EXPRESSIONS_IN_ORDERBY: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_FILE_USAGE, &s, sizeof(s), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_FILE_USAGE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_GETDATA_EXTENSIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_GROUP_BY");
	printf("SQL_GROUP_BY: ");
	switch (s) {
	case SQL_GB_COLLATE:
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_IDENTIFIER_CASE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_IDENTIFIER_QUOTE_CHAR");
	printf("SQL_IDENTIFIER_QUOTE_CHAR: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_INDEX_KEYWORDS, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_INDEX_KEYWORDS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_INFO_SCHEMA_VIEWS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_INSERT_STATEMENT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_INTEGRITY");
	printf("SQL_INTEGRITY: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_KEYSET_CURSOR_ATTRIBUTES1, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_KEYSET_CURSOR_ATTRIBUTES1");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_KEYSET_CURSOR_ATTRIBUTES2");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_NULL_COLLATION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_NUMERIC_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ODBC_INTERFACE_CONFORMANCE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ODBC_VER");
	printf("SQL_ODBC_VER: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_OJ_CAPABILITIES, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_OJ_CAPABILITIES");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ORDER_BY_COLUMNS_IN_SELECT");
	printf("SQL_ORDER_BY_COLUMNS_IN_SELECT: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_PARAM_ARRAY_ROW_COUNTS, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_PARAM_ARRAY_ROW_COUNTS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_PARAM_ARRAY_SELECTS");

	ret = SQLGetInfo(dbc, SQL_POS_OPERATIONS, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_POS_OPERATIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_PROCEDURES");
	printf("SQL_PROCEDURES: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_PROCEDURE_TERM, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_PROCEDURE_TERM");
	printf("SQL_PROCEDURE_TERM: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_QUOTED_IDENTIFIER_CASE, &s, sizeof(s), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_QUOTED_IDENTIFIER_CASE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_ROW_UPDATES");
	printf("SQL_ROW_UPDATES: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_SCHEMA_TERM, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SCHEMA_TERM");
	printf("SQL_SCHEMA_TERM: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_SCHEMA_USAGE, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SCHEMA_USAGE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SCROLL_OPTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_DATETIME_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_FOREIGN_KEY_DELETE_RULE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_FOREIGN_KEY_UPDATE_RULE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_GRANT");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_NUMERIC_VALUE_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_PREDICATES");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_RELATIONAL_JOIN_OPERATORS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_REVOKE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_ROW_VALUE_CONSTRUCTOR");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_STRING_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SQL92_VALUE_EXPRESSIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_STANDARD_CLI_CONFORMANCE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_STATIC_CURSOR_ATTRIBUTES1");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_STATIC_CURSOR_ATTRIBUTES2");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_STRING_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SUBQUERIES");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_SYSTEM_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TABLE_TERM");
	printf("SQL_TABLE_TERM: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_TIMEDATE_ADD_INTERVALS, &i, sizeof(i), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TIMEDATE_ADD_INTERVALS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TIMEDATE_DIFF_INTERVALS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TIMEDATE_FUNCTIONS");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TXN_CAPABLE");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_TXN_ISOLATION_OPTION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_UNION");
	printf("SQL_UNION:");
	if (i & SQL_U_UNION)
		printf(" SQL_U_UNION");
	...
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_USER_NAME");
	printf("SQL_USER_NAME: %.*s\n", resultlen, str);

	ret = SQLGetInfo(dbc, SQL_XOPEN_CLI_YEAR, str, sizeof(str), &resultlen);
	check(ret, SQL_HANDLE_DBC, dbc, "SQLGetInfo SQL_XOPEN_CLI_YEAR");
