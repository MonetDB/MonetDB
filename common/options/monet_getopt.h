...
/* Internal only.  Users should not call this directly.  */
	moptions_export int _getopt_internal(int __argc__, char *const *__argv__, const char *__shortopts, const struct option *__longopts, int *__longind, int __long_only);
# endif
#else				/* not __STDC__ */
#ifndef HAVE_GETOPT
	moptions_export int getopt();
